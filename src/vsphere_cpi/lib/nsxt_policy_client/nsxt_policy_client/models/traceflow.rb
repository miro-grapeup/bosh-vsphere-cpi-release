...
module NSXT
  class Traceflow
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, operation_state, logical_counters, timeout, result_overflowed, lport_id, counters, request_status, analysis].hash
    end
