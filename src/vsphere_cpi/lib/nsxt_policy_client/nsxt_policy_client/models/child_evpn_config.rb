...
module NSXT
  ...
  class ChildEvpnConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EvpnConfig')
        self.evpn_config = attributes[:'EvpnConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @evpn_config.nil?
        invalid_properties.push('invalid value for "evpn_config", evpn_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @evpn_config.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, evpn_config].hash
    end
