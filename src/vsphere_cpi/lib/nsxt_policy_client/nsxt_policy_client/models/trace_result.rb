...
module NSXT
  class TraceResult
    ...
    def self.swagger_types
      {
        ...
        :'observations' => :'Array<TraceflowObservation>',
        :'packet_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'packet_id')
        self.packet_id = attributes[:'packet_id']
      end
    ...
    def valid?
      direction_validator = EnumAttributeValidator.new('String', ['FORWARD', 'BACKWARD'])
    ...
    def direction=(direction)
      validator = EnumAttributeValidator.new('String', ['FORWARD', 'BACKWARD'])
    ...
    def hash
      [direction, logical_counters, observations, packet_id, result_overflowed, analysis, counters].hash
    end
