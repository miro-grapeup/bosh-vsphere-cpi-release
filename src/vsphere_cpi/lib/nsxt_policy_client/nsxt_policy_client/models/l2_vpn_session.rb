...
module NSXT
  ...
  class L2VPNSession
    ...
    # TCP Maximum Segment Size Clamping Direction and Value. This feature is supported for L2VPN Sessions that are Server mode only. 
    ...
    def self.swagger_types
      {
        ...
        :'tcp_mss_clamping' => :'L2TcpMaxSegmentSizeClamping',
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, tcp_mss_clamping, transport_tunnels, tunnel_encapsulation, enabled].hash
    end
