...
module NSXT
  ...
  class EvpnTunnelEndpointConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'local_addresses')
        if (value = attributes[:'local_addresses']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if !@mtu.nil? && @mtu > 9100
        invalid_properties.push('invalid value for "mtu", must be smaller than or equal to 9100.')
      end
      ...
      if @edge_path.nil?
        invalid_properties.push('invalid value for "edge_path", edge_path cannot be nil.')
      end

      if @local_addresses.nil?
        invalid_properties.push('invalid value for "local_addresses", local_addresses cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@mtu.nil? && @mtu > 9100
      return false if !@mtu.nil? && @mtu < 64
      return false if @edge_path.nil?
      return false if @local_addresses.nil?
      true
    end
    ...
    def mtu=(mtu)
      if !mtu.nil? && mtu > 9100
        fail ArgumentError, 'invalid value for "mtu", must be smaller than or equal to 9100.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          local_addresses == o.local_addresses
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, mtu, edge_path, local_addresses].hash
    end
