...
module NSXT
  ...
  class ConsolidatedStatus
    ...
    def valid?
      consolidated_status_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'IN_PROGRESS', 'ERROR', 'UNKNOWN', 'UNINITIALIZED'])
      return false unless consolidated_status_validator.valid?(@consolidated_status)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] consolidated_status Object to be assigned
    def consolidated_status=(consolidated_status)
      validator = EnumAttributeValidator.new('String', ['SUCCESS', 'IN_PROGRESS', 'ERROR', 'UNKNOWN', 'UNINITIALIZED'])
      unless validator.valid?(consolidated_status)
        fail ArgumentError, 'invalid value for "consolidated_status", must be one of #{validator.allowable_values}.'
      end
      @consolidated_status = consolidated_status
    end
