...
module NSXT
  ...
  class ChildIpv6DadProfile
    ...
    attr_accessor :ipv6_dad_profile
    ...
    def self.attribute_map
      {
        ...
        :'ipv6_dad_profile' => :'Ipv6DadProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Ipv6DadProfile')
        self.ipv6_dad_profile = attributes[:'Ipv6DadProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ipv6_dad_profile.nil?
        invalid_properties.push('invalid value for "ipv6_dad_profile", ipv6_dad_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipv6_dad_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipv6_dad_profile == o.ipv6_dad_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ipv6_dad_profile].hash
    end
