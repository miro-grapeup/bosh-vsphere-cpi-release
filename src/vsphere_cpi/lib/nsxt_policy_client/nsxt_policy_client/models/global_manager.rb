...
module NSXT
  ...
  class GlobalManager
    ...
    def self.swagger_types
      {
        ...
        :'mode' => :'String',
        :'connection_info' => :'Array<SiteNodeConnectionInfo>',
        :'maximum_rtt' => :'Integer',
        :'site_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'federation_id')
        self.federation_id = attributes[:'federation_id']
      end
      ...
      if attributes.has_key?(:'connection_info')
        if (value = attributes[:'connection_info']).is_a?(Array)
          self.connection_info = value
        end
      end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ['ACTIVE', 'STANDBY'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, fail_if_rtt_exceeded, federation_id, mode, connection_info, maximum_rtt, site_id].hash
    end
