...
module NSXT
  ...
  class ChildVhc
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Vhc')
        self.vhc = attributes[:'Vhc']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vhc.nil?
        invalid_properties.push('invalid value for "vhc", vhc cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, vhc].hash
    end
