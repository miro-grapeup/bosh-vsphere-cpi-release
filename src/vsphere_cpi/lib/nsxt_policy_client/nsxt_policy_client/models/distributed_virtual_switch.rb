...
module NSXT
  ...
  class DistributedVirtualSwitch
    ...
    attr_accessor :discovered_nodes

    # Uplink portgroup of distributed virtual switch
    attr_accessor :uplink_portgroup
    ...
    attr_accessor :lacp_group_configs

    # The uniform name of uplink ports on each host.
    attr_accessor :uplink_port_names
    ...
    def self.swagger_types
      {
        ...
        :'origin_type' => :'String',
        :'origin_id' => :'String',
        :'discovered_nodes' => :'Array<DiscoveredNode>',
        :'uplink_portgroup' => :'DistributedVirtualPortgroup',
        :'uuid' => :'String',
        :'origin_properties' => :'Array<KeyValuePair>',
        :'lacp_group_configs' => :'Array<LacpGroupConfigInfo>',
        :'uplink_port_names' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'discovered_nodes')
        if (value = attributes[:'discovered_nodes']).is_a?(Array)
          self.discovered_nodes = value
        end
      end

      if attributes.has_key?(:'uplink_portgroup')
        self.uplink_portgroup = attributes[:'uplink_portgroup']
      end
      ...
      if attributes.has_key?(:'lacp_group_configs')
        if (value = attributes[:'lacp_group_configs']).is_a?(Array)
          self.lacp_group_configs = value
        end
      end

      if attributes.has_key?(:'uplink_port_names')
        if (value = attributes[:'uplink_port_names']).is_a?(Array)
          self.uplink_port_names = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          discovered_nodes == o.discovered_nodes &&
          uplink_portgroup == o.uplink_portgroup &&
          uuid == o.uuid &&
          origin_properties == o.origin_properties &&
          lacp_group_configs == o.lacp_group_configs &&
          uplink_port_names == o.uplink_port_names
    end
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, cm_local_id, external_id, origin_type, origin_id, discovered_nodes, uplink_portgroup, uuid, origin_properties, lacp_group_configs, uplink_port_names].hash
    end
