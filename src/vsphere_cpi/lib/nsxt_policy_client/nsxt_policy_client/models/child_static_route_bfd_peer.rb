...
module NSXT
  ...
  class ChildStaticRouteBfdPeer
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BfdPeer')
        self.bfd_peer = attributes[:'BfdPeer']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bfd_peer.nil?
        invalid_properties.push('invalid value for "bfd_peer", bfd_peer cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, bfd_peer].hash
    end
