...
module NSXT
  ...
  class AutoRds
    ...
    attr_accessor :l3_auto_rd

    # List of layer 2 Auto assigned Route Distinguisher
    attr_accessor :l2_auto_rds
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'l3_auto_rd')
        self.l3_auto_rd = attributes[:'l3_auto_rd']
      end

      if attributes.has_key?(:'l2_auto_rds')
        if (value = attributes[:'l2_auto_rds']).is_a?(Array)
          self.l2_auto_rds = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          l3_auto_rd == o.l3_auto_rd &&
          l2_auto_rds == o.l2_auto_rds
    end
