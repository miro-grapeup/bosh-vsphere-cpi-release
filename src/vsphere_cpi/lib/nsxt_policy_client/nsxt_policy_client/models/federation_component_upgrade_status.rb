...
module NSXT
  class FederationComponentUpgradeStatus
    ...
    def self.swagger_types
      {
        ...
        :'current_version_node_summary' => :'Array<FederationNodeSummary>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'current_version_node_summary')
        if (value = attributes[:'current_version_node_summary']).is_a?(Array)
          self.current_version_node_summary = value
        end
      end
    end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'FAILED', 'IN_PROGRESS', 'NOT_STARTED', 'PAUSED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_version_node_summary == o.current_version_node_summary
    end
    ...
    def hash
      [status, target_version, details, component_type, percent_complete, current_version_node_summary].hash
    end
