...
module NSXT
  ...
  class IpAddressPool
    ...
    attr_accessor :ip_release_delay
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ip_release_delay')
        self.ip_release_delay = attributes[:'ip_release_delay']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ip_release_delay == o.ip_release_delay
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, ip_release_delay].hash
    end
