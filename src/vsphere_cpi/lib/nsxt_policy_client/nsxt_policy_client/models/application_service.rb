...
module NSXT
  ...
  class ApplicationService
    ...
    attr_accessor :service_template_id
    ...
    def self.swagger_types
      {
        ...
        :'attributes' => :'Array<ApplicationServiceAttribute>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_template_id')
        self.service_template_id = attributes[:'service_template_id']
      end
    ...
    def list_invalid_properties
      ...
      if @service_template_id.nil?
        invalid_properties.push('invalid value for "service_template_id", service_template_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @service_template_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_template_id == o.service_template_id &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, service_template_id, attributes].hash
    end
