...
module NSXT
  class CountActionArgument
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'count_type')
    ...
    def valid?
      count_type_validator = EnumAttributeValidator.new('String', ['ALL', 'INTERFACE_ONLY'])
    ...
    def count_type=(count_type)
      validator = EnumAttributeValidator.new('String', ['ALL', 'INTERFACE_ONLY'])
