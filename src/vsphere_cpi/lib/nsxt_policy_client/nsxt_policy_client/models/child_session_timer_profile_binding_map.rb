...
module NSXT
  ...
  class ChildSessionTimerProfileBindingMap
    ...
    attr_accessor :session_timer_profile_binding_map
    ...
    def self.attribute_map
      {
        ...
        :'session_timer_profile_binding_map' => :'SessionTimerProfileBindingMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SessionTimerProfileBindingMap')
        self.session_timer_profile_binding_map = attributes[:'SessionTimerProfileBindingMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @session_timer_profile_binding_map.nil?
        invalid_properties.push('invalid value for "session_timer_profile_binding_map", session_timer_profile_binding_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @session_timer_profile_binding_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          session_timer_profile_binding_map == o.session_timer_profile_binding_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, session_timer_profile_binding_map].hash
    end
