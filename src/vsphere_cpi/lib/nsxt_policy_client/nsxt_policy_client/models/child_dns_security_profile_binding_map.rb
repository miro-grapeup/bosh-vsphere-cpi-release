...
module NSXT
  ...
  class ChildDnsSecurityProfileBindingMap
    ...
    attr_accessor :dns_security_profile_binding_map
    ...
    def self.attribute_map
      {
        ...
        :'dns_security_profile_binding_map' => :'DnsSecurityProfileBindingMap'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DnsSecurityProfileBindingMap')
        self.dns_security_profile_binding_map = attributes[:'DnsSecurityProfileBindingMap']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dns_security_profile_binding_map.nil?
        invalid_properties.push('invalid value for "dns_security_profile_binding_map", dns_security_profile_binding_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dns_security_profile_binding_map.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dns_security_profile_binding_map == o.dns_security_profile_binding_map
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, dns_security_profile_binding_map].hash
    end
