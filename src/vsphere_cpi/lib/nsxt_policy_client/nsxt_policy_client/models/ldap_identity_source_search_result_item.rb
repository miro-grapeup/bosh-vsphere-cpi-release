...
module NSXT
  class LdapIdentitySourceSearchResultItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'principal_name')
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['USER', 'GROUP'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['USER', 'GROUP'])
    ...
    def hash
      [dn, common_name, principal_name, type].hash
    end
