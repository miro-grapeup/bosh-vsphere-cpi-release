...
module NSXT
  class TraceflowObservationReceivedLogical
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, svc_mac, src_component_id, component_id, lport_id, src_component_type, lport_name, src_component_name, vni].hash
    end
