...
module NSXT
  ...
  class ChildVniPoolConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VniPoolConfig')
        self.vni_pool_config = attributes[:'VniPoolConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vni_pool_config.nil?
        invalid_properties.push('invalid value for "vni_pool_config", vni_pool_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vni_pool_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vni_pool_config == o.vni_pool_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, vni_pool_config].hash
    end
