...
module NSXT
  ...
  class PolicyPimProfile
    ...
    def self.attribute_map
      {
        ...
        :'rp_address_multicast_ranges' => :'rp_address_multicast_ranges',
        :'bsm_enabled' => :'bsm_enabled',
    ...
    def self.swagger_types
      {
        ...
        :'rp_address_multicast_ranges' => :'Array<RpAddressMulticastRanges>',
        :'bsm_enabled' => :'BOOLEAN',
        :'rp_address' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rp_address_multicast_ranges')
        if (value = attributes[:'rp_address_multicast_ranges']).is_a?(Array)
          self.rp_address_multicast_ranges = value
        end
      end

      if attributes.has_key?(:'bsm_enabled')
        self.bsm_enabled = attributes[:'bsm_enabled']
      else
        self.bsm_enabled = true
      end

      if attributes.has_key?(:'rp_address')
        self.rp_address = attributes[:'rp_address']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rp_address_multicast_ranges == o.rp_address_multicast_ranges &&
          bsm_enabled == o.bsm_enabled &&
          rp_address == o.rp_address
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, rp_address_multicast_ranges, bsm_enabled, rp_address].hash
    end
