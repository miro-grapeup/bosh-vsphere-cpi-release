...
module NSXT
  ...
  class PolicyUrlCategorizationConfig
    ...
    # The ids of the context profiles that provides the list of categories to be detected. This field is deprecated. URL Categorization will not be supported in association with context profiles. 
    ...
    def list_invalid_properties
      ...
      if !@update_frequency.nil? && @update_frequency < 5
        invalid_properties.push('invalid value for "update_frequency", must be greater than or equal to 5.')
      end
    ...
    def valid?
      ...
      return false if !@update_frequency.nil? && @update_frequency < 5
    ...
    def update_frequency=(update_frequency)
      if !update_frequency.nil? && update_frequency < 5
        fail ArgumentError, 'invalid value for "update_frequency", must be greater than or equal to 5.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, update_frequency, context_profiles, enabled].hash
    end
