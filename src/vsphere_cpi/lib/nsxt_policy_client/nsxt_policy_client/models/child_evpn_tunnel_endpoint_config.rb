...
module NSXT
  ...
  class ChildEvpnTunnelEndpointConfig
    ...
    attr_accessor :evpn_tunnel_endpoint_config
    ...
    def self.attribute_map
      {
        ...
        :'evpn_tunnel_endpoint_config' => :'EvpnTunnelEndpointConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'EvpnTunnelEndpointConfig')
        self.evpn_tunnel_endpoint_config = attributes[:'EvpnTunnelEndpointConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @evpn_tunnel_endpoint_config.nil?
        invalid_properties.push('invalid value for "evpn_tunnel_endpoint_config", evpn_tunnel_endpoint_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @evpn_tunnel_endpoint_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          evpn_tunnel_endpoint_config == o.evpn_tunnel_endpoint_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, evpn_tunnel_endpoint_config].hash
    end
