...
module NSXT
  class SegmentCrossSiteTrafficStats
    # Total sent data counters.
    attr_accessor :tx_stats
    ...
    def self.swagger_types
      {
        :'tx_stats' => :'InterSitePortCounters',
        :'last_update_timestamp' => :'Integer',
        :'rx_stats' => :'InterSitePortCounters',
        :'segment_path' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tx_stats')
        self.tx_stats = attributes[:'tx_stats']
      end
      ...
      if attributes.has_key?(:'rx_stats')
        self.rx_stats = attributes[:'rx_stats']
      end
    ...
    def hash
      [tx_stats, last_update_timestamp, rx_stats, segment_path].hash
    end
