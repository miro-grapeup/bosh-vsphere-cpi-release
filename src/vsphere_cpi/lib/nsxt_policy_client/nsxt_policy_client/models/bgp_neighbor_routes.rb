...
module NSXT
  ...
  class BgpNeighborRoutes
    # BGP neighbor policy path
    attr_accessor :neighbor_path

    # Array of BGP neighbor route details per edge node. 
    attr_accessor :egde_node_routes
    ...
    def self.swagger_types
      {
        ...
        :'egde_node_routes' => :'Array<RoutesPerTransportNode>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'neighbor_path')
        self.neighbor_path = attributes[:'neighbor_path']
      end

      if attributes.has_key?(:'egde_node_routes')
        if (value = attributes[:'egde_node_routes']).is_a?(Array)
          self.egde_node_routes = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          neighbor_path == o.neighbor_path &&
          egde_node_routes == o.egde_node_routes &&
    ...
    def hash
      [neighbor_path, egde_node_routes, enforcement_point_path].hash
    end
