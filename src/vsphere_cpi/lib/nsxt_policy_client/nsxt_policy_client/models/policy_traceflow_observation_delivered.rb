...
module NSXT
  class PolicyTraceflowObservationDelivered
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resolution_type')
      ...
      if attributes.has_key?(:'target_mac')
        self.target_mac = attributes[:'target_mac']
      end
    ...
    def valid?
      ...
      resolution_type_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'ARP_SUPPRESSION_PORT_CACHE', 'ARP_SUPPRESSION_TABLE', 'ARP_SUPPRESSION_CP_QUERY', 'ARP_VM'])
    ...
    def resolution_type=(resolution_type)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'ARP_SUPPRESSION_PORT_CACHE', 'ARP_SUPPRESSION_TABLE', 'ARP_SUPPRESSION_CP_QUERY', 'ARP_VM'])
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, resolution_type, lport_name, target_mac, vlan_id, lport_id, segment_port_path].hash
    end
