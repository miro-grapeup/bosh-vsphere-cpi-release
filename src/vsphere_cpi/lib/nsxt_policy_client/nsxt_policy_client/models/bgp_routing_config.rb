...
module NSXT
  ...
  class BgpRoutingConfig
    ...
    attr_accessor :graceful_restart_config
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'graceful_restart_config' => :'BgpGracefulRestartConfig',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'graceful_restart_config')
        self.graceful_restart_config = attributes[:'graceful_restart_config']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          graceful_restart_config == o.graceful_restart_config &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, inter_sr_ibgp, local_as_num, graceful_restart, route_aggregations, enabled, graceful_restart_config, multipath_relax, ecmp].hash
    end
