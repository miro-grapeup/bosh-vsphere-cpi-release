...
module NSXT
  ...
  class SiteOffBoardingState
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['INITIALIZE_INPROGRESS', 'INITIALIZE_FAILED', 'INITIALIZE_SUCCESSFUL', 'CLEANUP_INPROGRESS', 'CLEANUP_FAILED', 'CLEANUP_SUCCESSFUL', 'REALIZATION_INPROGRESS', 'REALIZATION_FAILED', 'REALIZATION_SUCCESSFUL', 'TERMINAL_INPROGRESS', 'TERMINAL_FAILED', 'FAILED', 'SUCCESSFUL'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['INITIALIZE_INPROGRESS', 'INITIALIZE_FAILED', 'INITIALIZE_SUCCESSFUL', 'CLEANUP_INPROGRESS', 'CLEANUP_FAILED', 'CLEANUP_SUCCESSFUL', 'REALIZATION_INPROGRESS', 'REALIZATION_FAILED', 'REALIZATION_SUCCESSFUL', 'TERMINAL_INPROGRESS', 'TERMINAL_FAILED', 'FAILED', 'SUCCESSFUL'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, status, message].hash
    end
