...
module NSXT
  ...
  class ChildIdsSignature
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsSignature')
        self.ids_signature = attributes[:'IdsSignature']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_signature.nil?
        invalid_properties.push('invalid value for "ids_signature", ids_signature cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_signature.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_signature].hash
    end
