...
module NSXT
  ...
  class IPSecVpnService
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ha_sync')
        self.ha_sync = attributes[:'ha_sync']
      else
        self.ha_sync = true
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, ike_log_level, bypass_rules, ha_sync, enabled].hash
    end
