...
module NSXT
  ...
  class ContainerCluster
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'infrastructure')
        self.infrastructure = attributes[:'infrastructure']
      end

      if attributes.has_key?(:'cluster_type')
    ...
    def valid?
      ...
      cluster_type_validator = EnumAttributeValidator.new('String', ['PAS', 'PKS', 'Kubernetes', 'Openshift', 'WCP', 'WCP_Guest', 'Other'])
    ...
    def cluster_type=(cluster_type)
      validator = EnumAttributeValidator.new('String', ['PAS', 'PKS', 'Kubernetes', 'Openshift', 'WCP', 'WCP_Guest', 'Other'])
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, network_status, infrastructure, cluster_type, origin_properties, external_id, network_errors].hash
    end
