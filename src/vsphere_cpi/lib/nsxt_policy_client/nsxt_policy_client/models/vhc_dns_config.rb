...
module NSXT
  ...
  class VhcDnsConfig
    ...
    attr_accessor :dns_upstream_servers
    ...
    def self.swagger_types
      {
        ...
        :'dns_upstream_servers' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dns_upstream_servers')
        if (value = attributes[:'dns_upstream_servers']).is_a?(Array)
          self.dns_upstream_servers = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dns_upstream_servers.nil?
        invalid_properties.push('invalid value for "dns_upstream_servers", dns_upstream_servers cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dns_upstream_servers.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dns_upstream_servers == o.dns_upstream_servers
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, dns_upstream_servers].hash
    end
