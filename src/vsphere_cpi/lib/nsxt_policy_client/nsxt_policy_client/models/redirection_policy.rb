...
module NSXT
  ...
  class RedirectionPolicy
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'north_south')
        self.north_south = attributes[:'north_south']
      end
