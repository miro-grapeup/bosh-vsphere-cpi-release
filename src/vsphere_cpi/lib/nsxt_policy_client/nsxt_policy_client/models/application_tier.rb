...
module NSXT
  ...
  class ApplicationTier
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ip_range')
    ...
    def valid?
      ...
      access_type_validator = EnumAttributeValidator.new('String', ['Public', 'Private', 'Shared'])
      return false unless access_type_validator.valid?(@access_type)
      size_validator = EnumAttributeValidator.new('String', ['ONE', 'XXS', 'XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL'])
    ...
    def access_type=(access_type)
      validator = EnumAttributeValidator.new('String', ['Public', 'Private', 'Shared'])
    ...
    def size=(size)
      validator = EnumAttributeValidator.new('String', ['ONE', 'XXS', 'XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, ip_range, access_type, size].hash
    end
