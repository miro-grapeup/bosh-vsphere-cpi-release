...
module NSXT
  ...
  class IdsClusterConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ids_enabled')
        self.ids_enabled = attributes[:'ids_enabled']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_enabled.nil?
        invalid_properties.push('invalid value for "ids_enabled", ids_enabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_enabled.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, cluster, ids_enabled].hash
    end
