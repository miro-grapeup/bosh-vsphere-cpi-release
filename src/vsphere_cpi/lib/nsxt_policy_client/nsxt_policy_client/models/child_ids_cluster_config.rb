...
module NSXT
  ...
  class ChildIdsClusterConfig
    ...
    attr_accessor :ids_cluster_config
    ...
    def self.attribute_map
      {
        ...
        :'ids_cluster_config' => :'IdsClusterConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsClusterConfig')
        self.ids_cluster_config = attributes[:'IdsClusterConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_cluster_config.nil?
        invalid_properties.push('invalid value for "ids_cluster_config", ids_cluster_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_cluster_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_cluster_config == o.ids_cluster_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_cluster_config].hash
    end
