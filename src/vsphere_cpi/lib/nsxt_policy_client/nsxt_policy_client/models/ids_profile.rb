...
module NSXT
  ...
  class IdsProfile
    ...
    def self.attribute_map
      {
        ...
        :'overridden_signatures' => :'overridden_signatures'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'criteria' => :'Array<IdsProfileCriteria>',
        :'profile_severity' => :'Array<String>',
        :'severities' => :'Array<IdsProfileSeverity>',
        :'overridden_signatures' => :'Array<IdsProfileLocalSignature>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'profile_severity')
        if (value = attributes[:'profile_severity']).is_a?(Array)
          self.profile_severity = value
        end
      end

      if attributes.has_key?(:'severities')
        if (value = attributes[:'severities']).is_a?(Array)
          self.severities = value
        end
      end

      if attributes.has_key?(:'overridden_signatures')
        if (value = attributes[:'overridden_signatures']).is_a?(Array)
          self.overridden_signatures = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          criteria == o.criteria &&
          profile_severity == o.profile_severity &&
          severities == o.severities &&
          overridden_signatures == o.overridden_signatures
    end
