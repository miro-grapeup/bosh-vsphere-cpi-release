...
module NSXT
  ...
  class ChildSegmentMonitoringProfileBindingMap
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, segment_monitoring_profile_binding_map].hash
    end
