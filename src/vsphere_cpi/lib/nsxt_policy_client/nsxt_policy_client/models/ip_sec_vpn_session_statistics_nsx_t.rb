...
module NSXT
  ...
  class IPSecVpnSessionStatisticsNsxT
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, ike_traffic_statistics, display_name, policy_statistics, last_update_timestamp, ike_status, aggregate_traffic_counters].hash
    end
