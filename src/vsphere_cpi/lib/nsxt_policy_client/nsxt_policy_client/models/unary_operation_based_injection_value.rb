...
module NSXT
  ...
  class UnaryOperationBasedInjectionValue
    ...
    def self.swagger_types
      {
        ...
        :'initial_value' => :'ResourceFieldPointer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'initial_value')
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['UnaryOperationBasedInjectionValue'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['UnaryOperationBasedInjectionValue'])
    ...
    def hash
      [resource_type, operation, initial_value].hash
    end
