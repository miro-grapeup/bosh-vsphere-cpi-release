...
module NSXT
  ...
  class ActiveDirectoryIdentitySource
    ...
    attr_accessor :alternative_domain_names
    ...
    def self.swagger_types
      {
        ...
        :'ldap_servers' => :'Array<IdentitySourceLdapServer>',
        :'base_dn' => :'String',
        :'domain_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'alternative_domain_names')
        if (value = attributes[:'alternative_domain_names']).is_a?(Array)
          self.alternative_domain_names = value
        end
      end
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['ActiveDirectoryIdentitySource', 'OpenLdapIdentitySource'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['ActiveDirectoryIdentitySource', 'OpenLdapIdentitySource'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          alternative_domain_names == o.alternative_domain_names
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, ldap_servers, base_dn, domain_name, alternative_domain_names].hash
    end
