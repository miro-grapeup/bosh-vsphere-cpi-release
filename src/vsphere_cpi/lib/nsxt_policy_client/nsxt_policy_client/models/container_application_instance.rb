...
module NSXT
  ...
  class ContainerApplicationInstance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cluster_node_id')
        self.cluster_node_id = attributes[:'cluster_node_id']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'HEALTHY', 'UP', 'DOWN', 'DEGRADED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'HEALTHY', 'UP', 'DOWN', 'DEGRADED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cluster_node_id == o.cluster_node_id &&
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, status, network_status, container_cluster_id, cluster_node_id, external_id, origin_properties, container_application_ids, container_project_id, network_errors].hash
    end
