...
module NSXT
  ...
  class EvpnConfig
    ...
    attr_accessor :encapsulation_method
    ...
    def self.swagger_types
      {
        ...
        :'encapsulation_method' => :'EvpnEncapConfig',
        :'mode' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'encapsulation_method')
        self.encapsulation_method = attributes[:'encapsulation_method']
      end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ['INLINE', 'ROUTE_SERVER', 'DISABLE'])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ['INLINE', 'ROUTE_SERVER', 'DISABLE'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          encapsulation_method == o.encapsulation_method &&
          mode == o.mode
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, encapsulation_method, mode].hash
    end
