...
module NSXT
  ...
  class LBCookiePersistenceProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cookie_secure')
        self.cookie_secure = attributes[:'cookie_secure']
      else
      ...
      if attributes.has_key?(:'cookie_httponly')
        self.cookie_httponly = attributes[:'cookie_httponly']
      else
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['LBSourceIpPersistenceProfile', 'LBCookiePersistenceProfile', 'LBGenericPersistenceProfile'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['LBSourceIpPersistenceProfile', 'LBCookiePersistenceProfile', 'LBGenericPersistenceProfile'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, persistence_shared, cookie_garble, cookie_secure, cookie_fallback, cookie_mode, cookie_domain, cookie_httponly, cookie_name, cookie_time, cookie_path].hash
    end
