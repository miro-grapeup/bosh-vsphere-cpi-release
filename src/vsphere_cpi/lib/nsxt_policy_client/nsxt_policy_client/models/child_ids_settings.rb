...
module NSXT
  ...
  class ChildIdsSettings
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsSettings')
        self.ids_settings = attributes[:'IdsSettings']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_settings.nil?
        invalid_properties.push('invalid value for "ids_settings", ids_settings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_settings.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_settings].hash
    end
