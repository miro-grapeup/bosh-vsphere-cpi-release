...
module NSXT
  ...
  class ChildIdsRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsRule')
        self.ids_rule = attributes[:'IdsRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_rule.nil?
        invalid_properties.push('invalid value for "ids_rule", ids_rule cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_rule].hash
    end
