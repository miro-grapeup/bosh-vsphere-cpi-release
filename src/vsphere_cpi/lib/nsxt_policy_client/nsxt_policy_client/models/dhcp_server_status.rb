...
module NSXT
  class DhcpServerStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stand_by_node')
        self.stand_by_node = attributes[:'stand_by_node']
      end
    ...
    def list_invalid_properties
      ...
      if @service_status.nil?
        invalid_properties.push('invalid value for "service_status", service_status cannot be nil.')
      end

      if @active_node.nil?
        invalid_properties.push('invalid value for "active_node", active_node cannot be nil.')
      end
    ...
    def valid?
      return false if @service_status.nil?
      service_status_validator = EnumAttributeValidator.new('String', ['UP', 'DOWN', 'ERROR', 'NO_STANDBY'])
      return false unless service_status_validator.valid?(@service_status)
      return false if @active_node.nil?
      true
    end
    ...
    def service_status=(service_status)
      validator = EnumAttributeValidator.new('String', ['UP', 'DOWN', 'ERROR', 'NO_STANDBY'])
    ...
    def hash
      [error_message, service_status, stand_by_node, active_node].hash
    end
