...
module NSXT
  ...
  class FederationConfig
    ...
    def self.swagger_types
      {
        :'site_config' => :'Array<SiteFederationConfig>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'site_config')
        if (value = attributes[:'site_config']).is_a?(Array)
          self.site_config = value
        end
      end
    end
