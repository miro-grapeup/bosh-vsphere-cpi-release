...
module NSXT
  ...
  class MetadataProxyConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'server_certificates')
        if (value = attributes[:'server_certificates']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @edge_cluster_path.nil?
        invalid_properties.push('invalid value for "edge_cluster_path", edge_cluster_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @edge_cluster_path.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, secret, server_certificates, edge_cluster_path, preferred_edge_paths, crypto_protocols, server_address, enable_standby_relocation].hash
    end
