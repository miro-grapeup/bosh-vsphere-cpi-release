...
module NSXT
  class PolicyTraceflowObservationReceivedLogical
    ...
    attr_accessor :src_component_path
    ...
    def self.attribute_map
      {
        ...
        :'src_component_path' => :'src_component_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'svc_mac')
        self.svc_mac = attributes[:'svc_mac']
      end
      ...
      if attributes.has_key?(:'src_component_path')
        self.src_component_path = attributes[:'src_component_path']
      end
    end
    ...
    def valid?
      ...
      src_component_type_validator = EnumAttributeValidator.new('String', ['PHYSICAL', 'LR', 'LS', 'DFW', 'BRIDGE', 'EDGE_TUNNEL', 'EDGE_HOSTSWITCH', 'FW_BRIDGE', 'LOAD_BALANCER', 'NAT', 'IPSEC', 'SERVICE_INSERTION', 'VMC', 'SPOOFGUARD', 'EDGE_FW', 'DLB', 'UNKNOWN'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          src_component_path == o.src_component_path
    end
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, svc_mac, src_component_id, component_id, lport_id, src_component_type, lport_name, src_component_name, vni, component_path, segment_port_path, src_component_path].hash
    end
