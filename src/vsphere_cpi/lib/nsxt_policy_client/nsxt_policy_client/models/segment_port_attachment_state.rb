...
module NSXT
  ...
  class SegmentPortAttachmentState
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'attachers')
        if (value = attributes[:'attachers']).is_a?(Array)
          self.attachers = value
        end
      end
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ['FREE', 'ATTACHED', 'ATTACHED_PENDING_CONF', 'ATTACHED_IN_MOTION', 'DETACHED'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['FREE', 'ATTACHED', 'ATTACHED_PENDING_CONF', 'ATTACHED_IN_MOTION', 'DETACHED'])
