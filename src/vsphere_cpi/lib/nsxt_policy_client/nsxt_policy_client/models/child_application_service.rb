...
module NSXT
  ...
  class ChildApplicationService
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ApplicationService')
        self.application_service = attributes[:'ApplicationService']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @application_service.nil?
        invalid_properties.push('invalid value for "application_service", application_service cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @application_service.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, application_service].hash
    end
