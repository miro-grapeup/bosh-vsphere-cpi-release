...
module NSXT
  ...
  class ChildPolicyGroupReference
    ...
    attr_accessor :policy_group_reference
    ...
    def self.attribute_map
      {
        ...
        :'policy_group_reference' => :'PolicyGroupReference'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyGroupReference')
        self.policy_group_reference = attributes[:'PolicyGroupReference']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_group_reference.nil?
        invalid_properties.push('invalid value for "policy_group_reference", policy_group_reference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_group_reference.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_group_reference == o.policy_group_reference
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_group_reference].hash
    end
