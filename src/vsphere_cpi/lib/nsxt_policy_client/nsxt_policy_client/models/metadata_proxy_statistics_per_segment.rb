...
module NSXT
  class MetadataProxyStatisticsPerSegment
    ...
    def hash
      [requests_to_nova_server, responses_to_clients, succeeded_responses_from_nova_server, requests_from_clients, error_responses_from_nova_server, segment_path].hash
    end
