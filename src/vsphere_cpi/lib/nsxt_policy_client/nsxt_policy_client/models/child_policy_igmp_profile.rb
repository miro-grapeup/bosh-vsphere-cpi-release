...
module NSXT
  ...
  class ChildPolicyIgmpProfile
    ...
    attr_accessor :policy_igmp_profile
    ...
    def self.attribute_map
      {
        ...
        :'policy_igmp_profile' => :'PolicyIgmpProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyIgmpProfile')
        self.policy_igmp_profile = attributes[:'PolicyIgmpProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_igmp_profile.nil?
        invalid_properties.push('invalid value for "policy_igmp_profile", policy_igmp_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_igmp_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_igmp_profile == o.policy_igmp_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_igmp_profile].hash
    end
