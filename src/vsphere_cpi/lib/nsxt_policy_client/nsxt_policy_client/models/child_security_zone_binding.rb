...
module NSXT
  ...
  class ChildSecurityZoneBinding
    ...
    attr_accessor :security_zone_binding
    ...
    def self.attribute_map
      {
        ...
        :'security_zone_binding' => :'SecurityZoneBinding'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SecurityZoneBinding')
        self.security_zone_binding = attributes[:'SecurityZoneBinding']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @security_zone_binding.nil?
        invalid_properties.push('invalid value for "security_zone_binding", security_zone_binding cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_zone_binding.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          security_zone_binding == o.security_zone_binding
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, security_zone_binding].hash
    end
