...
module NSXT
  ...
  class L2VpnSessionRemoteMacNsxT
    ...
    def self.swagger_types
      {
        ...
        :'display_name' => :'String',
        :'remote_macs' => :'Array<L2VpnSessionRemoteMacForSegment>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'remote_macs')
        if (value = attributes[:'remote_macs']).is_a?(Array)
          self.remote_macs = value
        end
      end
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['L2VpnSessionRemoteMacNsxT'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['L2VpnSessionRemoteMacNsxT'])
    ...
    def hash
      [alarm, enforcement_point_path, resource_type, display_name, remote_macs].hash
    end
