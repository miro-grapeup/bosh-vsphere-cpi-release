...
module NSXT
  ...
  class LBSslSniCondition
    ...
    def list_invalid_properties
      ...
      if @sni.nil?
        invalid_properties.push('invalid value for "sni", sni cannot be nil.')
      end
    ...
    def hash
      [inverse, type, case_sensitive, match_type, sni].hash
    end
