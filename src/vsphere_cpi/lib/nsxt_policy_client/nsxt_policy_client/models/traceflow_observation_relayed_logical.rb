...
module NSXT
  class TraceflowObservationRelayedLogical
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, message_type, dst_server_address, logical_comp_uuid, relay_server_address].hash
    end
