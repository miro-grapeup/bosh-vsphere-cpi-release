...
module NSXT
  class PolicyEdgeClusterInterSiteStatus
    ...
    attr_accessor :edge_cluster_name
    ...
    def self.swagger_types
      {
        ...
        :'member_status' => :'Array<PolicyEdgeClusterMemberInterSiteStatus>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'edge_cluster_name')
        self.edge_cluster_name = attributes[:'edge_cluster_name']
      end
    ...
    def valid?
      overall_status_validator = EnumAttributeValidator.new('String', ['UP', 'DOWN', 'DEGRADED', 'UNKNOWN'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          edge_cluster_name == o.edge_cluster_name &&
    ...
    def hash
      [last_update_timestamp, overall_status, edge_cluster_name, member_status, edge_cluster_path].hash
    end
