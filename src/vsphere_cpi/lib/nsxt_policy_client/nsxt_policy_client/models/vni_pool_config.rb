...
module NSXT
  ...
  class VniPoolConfig
    ...
    def list_invalid_properties
      ...
      if @start < 75001
        invalid_properties.push('invalid value for "start", must be greater than or equal to 75001.')
      end
      ...
      if @_end < 75001
        invalid_properties.push('invalid value for "_end", must be greater than or equal to 75001.')
      end
    ...
    def valid?
      ...
      return false if @start < 75001
      return false if @_end.nil?
      return false if @_end > 16777215
      return false if @_end < 75001
      true
    end
    ...
    def start=(start)
      ...
      if start < 75001
        fail ArgumentError, 'invalid value for "start", must be greater than or equal to 75001.'
      end
    ...
    def _end=(_end)
      ...
      if _end < 75001
        fail ArgumentError, 'invalid value for "_end", must be greater than or equal to 75001.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, start, _end].hash
    end
