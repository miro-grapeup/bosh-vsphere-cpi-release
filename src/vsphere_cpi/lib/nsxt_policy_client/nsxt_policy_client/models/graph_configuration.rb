...
module NSXT
  ...
  class GraphConfiguration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'x_value_type')
        self.x_value_type = attributes[:'x_value_type']
      else
        self.x_value_type = 'string'
      end
    ...
    def valid?
      ...
      x_value_type_validator = EnumAttributeValidator.new('String', ['string', 'number', 'date'])
      return false unless x_value_type_validator.valid?(@x_value_type)
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] x_value_type Object to be assigned
    def x_value_type=(x_value_type)
      validator = EnumAttributeValidator.new('String', ['string', 'number', 'date'])
      unless validator.valid?(x_value_type)
        fail ArgumentError, 'invalid value for "x_value_type", must be one of #{validator.allowable_values}.'
      end
      @x_value_type = x_value_type
    end
