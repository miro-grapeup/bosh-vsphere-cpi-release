...
module NSXT
  class IgmpMembershipCsvRecord
    ...
    attr_accessor :no_of_sources

    # IP address of multicast source.
    attr_accessor :source_address

    # IGMP version.
    attr_accessor :igmp_version
    ...
    def self.swagger_types
      {
        ...
        :'group' => :'String',
        :'interface' => :'String',
        :'no_of_sources' => :'String',
        :'source_address' => :'String',
        :'igmp_version' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'no_of_sources')
        self.no_of_sources = attributes[:'no_of_sources']
      end
      ...
      if attributes.has_key?(:'igmp_version')
        self.igmp_version = attributes[:'igmp_version']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          no_of_sources == o.no_of_sources &&
          source_address == o.source_address &&
          igmp_version == o.igmp_version
    end
    ...
    def hash
      [transport_node, uptime, group, interface, no_of_sources, source_address, igmp_version].hash
    end
