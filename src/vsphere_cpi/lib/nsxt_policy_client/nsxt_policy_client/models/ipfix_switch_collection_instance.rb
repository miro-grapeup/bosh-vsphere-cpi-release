...
module NSXT
  ...
  class IPFIXSwitchCollectionInstance
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, ipfix_collector_profile_paths, idle_timeout, source_logical_segment_paths, max_flows, observation_domain_id, active_timeout, packet_sample_probability].hash
    end
