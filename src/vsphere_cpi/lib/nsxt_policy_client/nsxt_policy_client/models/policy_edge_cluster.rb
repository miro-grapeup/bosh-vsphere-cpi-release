...
module NSXT
  ...
  class PolicyEdgeCluster
    ...
    attr_accessor :inter_site_forwarding_enabled
    ...
    def self.attribute_map
      {
        ...
        :'inter_site_forwarding_enabled' => :'inter_site_forwarding_enabled',
        :'nsx_id' => :'nsx_id',
        :'rtep_ips' => :'rtep_ips'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'inter_site_forwarding_enabled' => :'BOOLEAN',
        :'nsx_id' => :'String',
        :'rtep_ips' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'inter_site_forwarding_enabled')
        self.inter_site_forwarding_enabled = attributes[:'inter_site_forwarding_enabled']
      end
      ...
      if attributes.has_key?(:'rtep_ips')
        if (value = attributes[:'rtep_ips']).is_a?(Array)
          self.rtep_ips = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inter_site_forwarding_enabled == o.inter_site_forwarding_enabled &&
          nsx_id == o.nsx_id &&
          rtep_ips == o.rtep_ips
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, inter_site_forwarding_enabled, nsx_id, rtep_ips].hash
    end
