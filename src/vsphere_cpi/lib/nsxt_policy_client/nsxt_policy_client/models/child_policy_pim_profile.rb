...
module NSXT
  ...
  class ChildPolicyPimProfile
    ...
    attr_accessor :policy_pim_profile
    ...
    def self.attribute_map
      {
        ...
        :'policy_pim_profile' => :'PolicyPimProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyPimProfile')
        self.policy_pim_profile = attributes[:'PolicyPimProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_pim_profile.nil?
        invalid_properties.push('invalid value for "policy_pim_profile", policy_pim_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_pim_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_pim_profile == o.policy_pim_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_pim_profile].hash
    end
