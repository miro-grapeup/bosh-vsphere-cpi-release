...
module NSXT
  ...
  class Site
    ...
    attr_accessor :fail_if_rtep_misconfigured
    ...
    attr_accessor :site_connection_info
    ...
    def self.attribute_map
      {
        ...
        :'fail_if_rtt_exceeded' => :'fail_if_rtt_exceeded',
        :'site_number' => :'site_number',
        :'maximum_rtt' => :'maximum_rtt',
        :'fail_if_rtep_misconfigured' => :'fail_if_rtep_misconfigured',
        :'site_connection_info' => :'site_connection_info'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'federation_config' => :'GmFederationSiteConfig',
        :'fail_if_rtt_exceeded' => :'BOOLEAN',
        :'site_number' => :'Integer',
        :'maximum_rtt' => :'Integer',
        :'fail_if_rtep_misconfigured' => :'BOOLEAN',
        :'site_connection_info' => :'Array<SiteNodeConnectionInfo>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fail_if_rtt_exceeded')
        self.fail_if_rtt_exceeded = attributes[:'fail_if_rtt_exceeded']
      else
        self.fail_if_rtt_exceeded = true
      end

      if attributes.has_key?(:'site_number')
        self.site_number = attributes[:'site_number']
      end

      if attributes.has_key?(:'maximum_rtt')
        self.maximum_rtt = attributes[:'maximum_rtt']
      else
        self.maximum_rtt = 250
      end

      if attributes.has_key?(:'fail_if_rtep_misconfigured')
        self.fail_if_rtep_misconfigured = attributes[:'fail_if_rtep_misconfigured']
      else
        self.fail_if_rtep_misconfigured = true
      end

      if attributes.has_key?(:'site_connection_info')
        if (value = attributes[:'site_connection_info']).is_a?(Array)
          self.site_connection_info = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@maximum_rtt.nil? && @maximum_rtt > 1000
        invalid_properties.push('invalid value for "maximum_rtt", must be smaller than or equal to 1000.')
      end

      if !@maximum_rtt.nil? && @maximum_rtt < 0
        invalid_properties.push('invalid value for "maximum_rtt", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@maximum_rtt.nil? && @maximum_rtt > 1000
      return false if !@maximum_rtt.nil? && @maximum_rtt < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] maximum_rtt Value to be assigned
    def maximum_rtt=(maximum_rtt)
      if !maximum_rtt.nil? && maximum_rtt > 1000
        fail ArgumentError, 'invalid value for "maximum_rtt", must be smaller than or equal to 1000.'
      end

      if !maximum_rtt.nil? && maximum_rtt < 0
        fail ArgumentError, 'invalid value for "maximum_rtt", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fail_if_rtt_exceeded == o.fail_if_rtt_exceeded &&
          site_number == o.site_number &&
          maximum_rtt == o.maximum_rtt &&
          fail_if_rtep_misconfigured == o.fail_if_rtep_misconfigured &&
          site_connection_info == o.site_connection_info
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, federation_config, fail_if_rtt_exceeded, site_number, maximum_rtt, fail_if_rtep_misconfigured, site_connection_info].hash
    end
