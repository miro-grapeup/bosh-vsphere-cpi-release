...
module NSXT
  ...
  class ExportRequestParameter
    ...
    def list_invalid_properties
      ...
      if !@passphrase.nil? && @passphrase.to_s.length < 8
        invalid_properties.push('invalid value for "passphrase", the character length must be great than or equal to 8.')
      end
    ...
    def valid?
      return false if !@passphrase.nil? && @passphrase.to_s.length < 8
      true
    end
    ...
    def passphrase=(passphrase)
      if !passphrase.nil? && passphrase.to_s.length < 8
        fail ArgumentError, 'invalid value for "passphrase", the character length must be great than or equal to 8.'
      end
