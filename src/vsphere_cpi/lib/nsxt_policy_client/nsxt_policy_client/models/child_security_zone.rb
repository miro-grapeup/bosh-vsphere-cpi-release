...
module NSXT
  ...
  class ChildSecurityZone
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SecurityZone')
        self.security_zone = attributes[:'SecurityZone']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @security_zone.nil?
        invalid_properties.push('invalid value for "security_zone", security_zone cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_zone.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, security_zone].hash
    end
