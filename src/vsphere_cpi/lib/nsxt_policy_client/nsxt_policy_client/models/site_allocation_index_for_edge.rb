...
module NSXT
  ...
  class SiteAllocationIndexForEdge
    ...
    attr_accessor :target_resource_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'target_resource_path')
        self.target_resource_path = attributes[:'target_resource_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          index == o.index &&
          target_resource_path == o.target_resource_path
    end
    ...
    def hash
      [index, target_resource_path].hash
    end
