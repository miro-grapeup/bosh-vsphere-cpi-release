...
module NSXT
  ...
  class TlsListenerCertificate
    ...
    def valid?
      result_validator = EnumAttributeValidator.new('String', ['SUCCESS', 'CONNECTION_TIMEOUT', 'NO_ROUTE_TO_HOST', 'CONNECTION_REFUSED'])
    ...
    def result=(result)
      validator = EnumAttributeValidator.new('String', ['SUCCESS', 'CONNECTION_TIMEOUT', 'NO_ROUTE_TO_HOST', 'CONNECTION_REFUSED'])
    ...
    def hash
      [result, certificate, thumbprint].hash
    end
