...
module NSXT
  ...
  class PolicyDraft
    ...
    attr_accessor :ref_draft_path

    # Comments for a policy draft lock/unlock.
    attr_accessor :lock_comments
    ...
    attr_accessor :user_area

    # ID of the user who last modified the lock for a policy draft. 
    attr_accessor :lock_modified_by

    # In case of a large draft, wherein the size of user_area is so big that it can not be stored into one draft object, the data is then gets stored into multiple chunks in a draft data store. This value represents the ID of that data store. 
    attr_accessor :user_area_store_id

    # In case of a large draft, wherein the size of system_area is so big that it can not be stored into one draft object, the data is then gets stored into multiple chunks in a draft data store. This value represents the ID of that data store. 
    attr_accessor :system_area_store_id
    ...
    def self.attribute_map
      {
        ...
        :'ref_draft_path' => :'ref_draft_path',
        :'lock_comments' => :'lock_comments',
        :'locked' => :'locked',
        :'user_area' => :'user_area',
        :'lock_modified_by' => :'lock_modified_by',
        :'user_area_store_id' => :'user_area_store_id',
        :'system_area_store_id' => :'system_area_store_id',
    ...
    def self.swagger_types
      {
        ...
        :'user_area_store_id' => :'String',
        :'system_area_store_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ref_draft_path')
        self.ref_draft_path = attributes[:'ref_draft_path']
      end

      if attributes.has_key?(:'lock_comments')
        self.lock_comments = attributes[:'lock_comments']
      end
      ...
      if attributes.has_key?(:'user_area')
        self.user_area = attributes[:'user_area']
      end
      ...
      if attributes.has_key?(:'user_area_store_id')
        self.user_area_store_id = attributes[:'user_area_store_id']
      end

      if attributes.has_key?(:'system_area_store_id')
        self.system_area_store_id = attributes[:'system_area_store_id']
      end
      ...
      if attributes.has_key?(:'system_area')
        self.system_area = attributes[:'system_area']
      end

      if attributes.has_key?(:'is_auto_draft')
        self.is_auto_draft = attributes[:'is_auto_draft']
      else
        self.is_auto_draft = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ref_draft_path == o.ref_draft_path &&
          lock_comments == o.lock_comments &&
          locked == o.locked &&
          user_area == o.user_area &&
          lock_modified_by == o.lock_modified_by &&
          user_area_store_id == o.user_area_store_id &&
          system_area_store_id == o.system_area_store_id &&
          lock_modified_time == o.lock_modified_time &&
          system_area == o.system_area &&
          is_auto_draft == o.is_auto_draft
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, ref_draft_path, lock_comments, locked, user_area, lock_modified_by, user_area_store_id, system_area_store_id, lock_modified_time, system_area, is_auto_draft].hash
    end
