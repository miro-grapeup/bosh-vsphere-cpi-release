...
module NSXT
  ...
  class LocalEgress
    ...
    attr_accessor :optimized_ips

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'optimized_ips' => :'optimized_ips'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'optimized_ips')
        if (value = attributes[:'optimized_ips']).is_a?(Array)
          self.optimized_ips = value
        end
      end
    end
