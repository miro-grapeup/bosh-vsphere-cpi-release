...
module NSXT
  ...
  class ChildTraceflowConfig
    ...
    attr_accessor :traceflow_config
    ...
    def self.attribute_map
      {
        ...
        :'traceflow_config' => :'TraceflowConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TraceflowConfig')
        self.traceflow_config = attributes[:'TraceflowConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @traceflow_config.nil?
        invalid_properties.push('invalid value for "traceflow_config", traceflow_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @traceflow_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          traceflow_config == o.traceflow_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, traceflow_config].hash
    end
