...
module NSXT
  ...
  class ChildGlobalManager
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GlobalManager')
        self.global_manager = attributes[:'GlobalManager']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @global_manager.nil?
        invalid_properties.push('invalid value for "global_manager", global_manager cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @global_manager.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          global_manager == o.global_manager
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, global_manager].hash
    end
