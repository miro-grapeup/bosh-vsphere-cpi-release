...
module NSXT
  ...
  class L2VPNService
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'encap_ip_pool')
        if (value = attributes[:'encap_ip_pool']).is_a?(Array)
          self.encap_ip_pool = value
        end
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, encap_ip_pool, mode, enable_hub].hash
    end
