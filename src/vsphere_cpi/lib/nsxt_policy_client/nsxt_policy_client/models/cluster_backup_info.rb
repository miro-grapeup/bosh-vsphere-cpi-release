...
module NSXT
  ...
  class ClusterBackupInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'restore_type')
        if (value = attributes[:'restore_type']).is_a?(Array)
          self.restore_type = value
        end
      end
    end
    ...
    def hash
      [timestamp, node_id, ip_address, restore_type].hash
    end
