...
module NSXT
  ...
  class ContainerClusterNode
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, network_status, container_cluster_id, ip_addresses, origin_properties, external_id, network_errors].hash
    end
