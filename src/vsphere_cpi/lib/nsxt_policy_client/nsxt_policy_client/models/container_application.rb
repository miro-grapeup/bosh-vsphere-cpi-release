...
module NSXT
  ...
  class ContainerApplication
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, status, network_status, container_cluster_id, origin_properties, external_id, container_project_id, network_errors].hash
    end
