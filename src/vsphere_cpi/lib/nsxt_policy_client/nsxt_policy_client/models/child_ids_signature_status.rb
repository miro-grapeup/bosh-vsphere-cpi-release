...
module NSXT
  ...
  class ChildIdsSignatureStatus
    ...
    attr_accessor :ids_signature_status
    ...
    def self.attribute_map
      {
        ...
        :'ids_signature_status' => :'IdsSignatureStatus'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsSignatureStatus')
        self.ids_signature_status = attributes[:'IdsSignatureStatus']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_signature_status.nil?
        invalid_properties.push('invalid value for "ids_signature_status", ids_signature_status cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_signature_status.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_signature_status == o.ids_signature_status
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_signature_status].hash
    end
