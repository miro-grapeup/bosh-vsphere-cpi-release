...
module NSXT
  ...
  class ComputeClusterIdfwConfiguration
    ...
    attr_accessor :cluster_idfw_enabled
    ...
    def self.attribute_map
      {
        ...
        :'member' => :'member',
        :'cluster_idfw_enabled' => :'cluster_idfw_enabled'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cluster_idfw_enabled')
        self.cluster_idfw_enabled = attributes[:'cluster_idfw_enabled']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cluster_idfw_enabled.nil?
        invalid_properties.push('invalid value for "cluster_idfw_enabled", cluster_idfw_enabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cluster_idfw_enabled.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          member == o.member &&
          cluster_idfw_enabled == o.cluster_idfw_enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, member, cluster_idfw_enabled].hash
    end
