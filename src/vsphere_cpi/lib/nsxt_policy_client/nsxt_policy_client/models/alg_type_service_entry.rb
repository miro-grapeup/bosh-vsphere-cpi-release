...
module NSXT
  ...
  class ALGTypeServiceEntry
    ...
    def list_invalid_properties
      ...
      if @destination_ports.nil?
        invalid_properties.push('invalid value for "destination_ports", destination_ports cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @destination_ports.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, alg, destination_ports, source_ports].hash
    end
