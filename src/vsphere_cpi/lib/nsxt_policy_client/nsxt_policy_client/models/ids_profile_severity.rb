...
module NSXT
  ...
  class IdsProfileSeverity
    ...
    # Contains the id of signatures that will be ignored as part of the profile. This field is deprecated, please use ignore_signatures field under IdsProfile to ignore the signatures. 
    attr_accessor :ignore_signatures
    ...
    def self.swagger_types
      {
        ...
        :'ignore_signatures' => :'Array<String>',
        :'severity' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ignore_signatures')
        if (value = attributes[:'ignore_signatures']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignore_signatures == o.ignore_signatures &&
          severity == o.severity
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, ignore_signatures, severity].hash
    end
