...
module NSXT
  ...
  class ChildMetadataProxyConfig
    ...
    attr_accessor :metadata_proxy_config
    ...
    def self.attribute_map
      {
        ...
        :'metadata_proxy_config' => :'MetadataProxyConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MetadataProxyConfig')
        self.metadata_proxy_config = attributes[:'MetadataProxyConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @metadata_proxy_config.nil?
        invalid_properties.push('invalid value for "metadata_proxy_config", metadata_proxy_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @metadata_proxy_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          metadata_proxy_config == o.metadata_proxy_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, metadata_proxy_config].hash
    end
