...
module NSXT
  ...
  class Vhc
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'public_ip_addresses')
        if (value = attributes[:'public_ip_addresses']).is_a?(Array)
          self.public_ip_addresses = value
        end
      end

      if attributes.has_key?(:'private_ip_addresses')
    ...
    def list_invalid_properties
      ...
      if @site_infos.nil?
        invalid_properties.push('invalid value for "site_infos", site_infos cannot be nil.')
      end
      ...
      if @tier_0s.nil?
        invalid_properties.push('invalid value for "tier_0s", tier_0s cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, site_infos, public_ip_addresses, private_ip_addresses, capabilities, tier_0s].hash
    end
