...
module NSXT
  class InterfaceArpTable
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<InterfaceArpEntry>',
        :'edge_path' => :'String',
    ...
    def list_invalid_properties
      ...
      if @interface_path.nil?
        invalid_properties.push('invalid value for "interface_path", interface_path cannot be nil.')
      end
    ...
    def valid?
      return false if @interface_path.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, last_update_timestamp, interface_path, results, edge_path, enforcement_point_path].hash
    end
