...
module NSXT
  class PimRpMappingCsvRecord
    ...
    attr_accessor :outgoing_interface
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_rp')
        self.is_rp = attributes[:'is_rp']
      end
      ...
      if attributes.has_key?(:'outgoing_interface')
        self.outgoing_interface = attributes[:'outgoing_interface']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          group == o.group &&
          source == o.source &&
          outgoing_interface == o.outgoing_interface &&
    ...
    def hash
      [is_rp, transport_node, group, source, outgoing_interface, rp_address].hash
    end
