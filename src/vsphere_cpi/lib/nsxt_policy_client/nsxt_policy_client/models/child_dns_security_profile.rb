...
module NSXT
  ...
  class ChildDnsSecurityProfile
    ...
    attr_accessor :dns_security_profile
    ...
    def self.attribute_map
      {
        ...
        :'dns_security_profile' => :'DnsSecurityProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DnsSecurityProfile')
        self.dns_security_profile = attributes[:'DnsSecurityProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dns_security_profile.nil?
        invalid_properties.push('invalid value for "dns_security_profile", dns_security_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dns_security_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dns_security_profile == o.dns_security_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, dns_security_profile].hash
    end
