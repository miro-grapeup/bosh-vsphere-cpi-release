...
module NSXT
  ...
  class IdsSignatureVersion
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'change_log')
      ...
      if attributes.has_key?(:'user_uploaded')
        self.user_uploaded = attributes[:'user_uploaded']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['OUTDATED', 'LATEST'])
      return false unless status_validator.valid?(@status)
      state_validator = EnumAttributeValidator.new('String', ['ACTIVE', 'NOTACTIVE'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['OUTDATED', 'LATEST'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['ACTIVE', 'NOTACTIVE'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, status, change_log, update_time, user_uploaded, state, version_id].hash
    end
