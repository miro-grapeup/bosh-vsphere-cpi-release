...
module NSXT
  ...
  class EvpnTenantConfig
    ...
    def self.swagger_types
      {
        ...
        :'mappings' => :'Array<VlanVniRangePair>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vni_pool_path')
        self.vni_pool_path = attributes[:'vni_pool_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vni_pool_path.nil?
        invalid_properties.push('invalid value for "vni_pool_path", vni_pool_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vni_pool_path.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, transport_zone_path, mappings, vni_pool_path].hash
    end
