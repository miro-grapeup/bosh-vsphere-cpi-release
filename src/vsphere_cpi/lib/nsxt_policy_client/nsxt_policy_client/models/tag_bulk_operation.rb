...
module NSXT
  ...
  class TagBulkOperation
    ...
    def self.swagger_types
      {
        ...
        :'apply_to' => :'Array<ResourceInfo>',
        :'tag' => :'Tag',
        :'remove_from' => :'Array<ResourceInfo>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'remove_from')
        if (value = attributes[:'remove_from']).is_a?(Array)
          self.remove_from = value
        end
      end
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, apply_to, tag, remove_from].hash
    end
