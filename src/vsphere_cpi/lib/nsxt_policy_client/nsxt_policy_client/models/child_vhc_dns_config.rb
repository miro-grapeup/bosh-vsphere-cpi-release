...
module NSXT
  ...
  class ChildVhcDnsConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'VhcDnsConfig')
        self.vhc_dns_config = attributes[:'VhcDnsConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vhc_dns_config.nil?
        invalid_properties.push('invalid value for "vhc_dns_config", vhc_dns_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vhc_dns_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vhc_dns_config == o.vhc_dns_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, vhc_dns_config].hash
    end
