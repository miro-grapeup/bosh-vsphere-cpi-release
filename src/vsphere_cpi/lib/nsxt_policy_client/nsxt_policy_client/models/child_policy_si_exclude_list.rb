...
module NSXT
  ...
  class ChildPolicySIExcludeList
    ...
    attr_accessor :policy_si_exclude_list
    ...
    def self.attribute_map
      {
        ...
        :'policy_si_exclude_list' => :'PolicySIExcludeList'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicySIExcludeList')
        self.policy_si_exclude_list = attributes[:'PolicySIExcludeList']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_si_exclude_list.nil?
        invalid_properties.push('invalid value for "policy_si_exclude_list", policy_si_exclude_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_si_exclude_list.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_si_exclude_list == o.policy_si_exclude_list
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_si_exclude_list].hash
    end
