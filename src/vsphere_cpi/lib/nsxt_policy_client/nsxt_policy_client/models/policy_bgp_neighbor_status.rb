...
module NSXT
  class PolicyBgpNeighborStatus
    ...
    def valid?
      connection_state_validator = EnumAttributeValidator.new('String', ['INVALID', 'IDLE', 'CONNECT', 'ACTIVE', 'OPEN_SENT', 'OPEN_CONFIRM', 'ESTABLISHED', 'UNKNOWN'])
    ...
    def connection_state=(connection_state)
      validator = EnumAttributeValidator.new('String', ['INVALID', 'IDLE', 'CONNECT', 'ACTIVE', 'OPEN_SENT', 'OPEN_CONFIRM', 'ESTABLISHED', 'UNKNOWN'])
    ...
    def hash
      [connection_state, messages_received, keep_alive_interval, tier0_path, neighbor_router_id, total_out_prefix_count, remote_as_number, messages_sent, time_since_established, hold_time, established_connection_count, graceful_restart_mode, connection_drop_count, remote_port, last_update_timestamp, total_in_prefix_count, remote_site, edge_path, local_port, announced_capabilities, negotiated_capability, address_families, source_address, neighbor_address].hash
    end
