...
module NSXT
  ...
  class ChildIdsStandaloneHostConfig
    ...
    attr_accessor :ids_standalone_host_config
    ...
    def self.attribute_map
      {
        ...
        :'ids_standalone_host_config' => :'IdsStandaloneHostConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsStandaloneHostConfig')
        self.ids_standalone_host_config = attributes[:'IdsStandaloneHostConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_standalone_host_config.nil?
        invalid_properties.push('invalid value for "ids_standalone_host_config", ids_standalone_host_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_standalone_host_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ids_standalone_host_config == o.ids_standalone_host_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_standalone_host_config].hash
    end
