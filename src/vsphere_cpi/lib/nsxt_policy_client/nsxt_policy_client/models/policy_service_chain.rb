...
module NSXT
  ...
  class PolicyServiceChain
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, reverse_path_service_profiles, path_selection_policy, service_segment_path, forward_path_service_profiles, failure_policy].hash
    end
