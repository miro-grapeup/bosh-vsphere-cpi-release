...
module NSXT
  ...
  class ImportTask
    ...
    def hash
      [_self, _links, _schema, status, async_response_available, description, start_time, cancelable, request_method, user, progress, message, request_uri, id, end_time, failure_msg, draft_path].hash
    end
