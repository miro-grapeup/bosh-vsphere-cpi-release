...
module NSXT
  ...
  class ChildPolicyFirewallScheduler
    ...
    attr_accessor :policy_firewall_scheduler
    ...
    def self.attribute_map
      {
        ...
        :'policy_firewall_scheduler' => :'PolicyFirewallScheduler'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyFirewallScheduler')
        self.policy_firewall_scheduler = attributes[:'PolicyFirewallScheduler']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_firewall_scheduler.nil?
        invalid_properties.push('invalid value for "policy_firewall_scheduler", policy_firewall_scheduler cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_firewall_scheduler.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_firewall_scheduler == o.policy_firewall_scheduler
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_firewall_scheduler].hash
    end
