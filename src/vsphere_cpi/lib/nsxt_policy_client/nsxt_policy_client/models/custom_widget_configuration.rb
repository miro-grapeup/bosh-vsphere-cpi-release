...
module NSXT
  ...
  class CustomWidgetConfiguration
    ...
    attr_accessor :ui_component_identifier
    ...
    def self.swagger_types
      {
        ...
        :'shared' => :'BOOLEAN',
        :'legend' => :'Legend',
        :'ui_component_identifier' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ui_component_identifier')
        self.ui_component_identifier = attributes[:'ui_component_identifier']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shared == o.shared &&
          legend == o.legend &&
          ui_component_identifier == o.ui_component_identifier
    end
