...
module NSXT
  ...
  class ChildBgpNeighborConfig
    ...
    attr_accessor :bgp_neighbor_config
    ...
    def self.attribute_map
      {
        ...
        :'bgp_neighbor_config' => :'BgpNeighborConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BgpNeighborConfig')
        self.bgp_neighbor_config = attributes[:'BgpNeighborConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bgp_neighbor_config.nil?
        invalid_properties.push('invalid value for "bgp_neighbor_config", bgp_neighbor_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bgp_neighbor_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bgp_neighbor_config == o.bgp_neighbor_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, bgp_neighbor_config].hash
    end
