...
module NSXT
  class SegmentPortMacAddressListResult
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<SegmentPortMacTableEntry>',
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, last_update_timestamp, results, transport_node_id].hash
    end
