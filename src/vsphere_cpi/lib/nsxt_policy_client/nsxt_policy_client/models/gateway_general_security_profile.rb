...
module NSXT
  class GatewayGeneralSecurityProfile
    ...
    attr_accessor :enable_double_flow
    ...
    def self.attribute_map
      {
        ...
        :'enable_double_flow' => :'enable_double_flow'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enable_double_flow')
        self.enable_double_flow = attributes[:'enable_double_flow']
      else
        self.enable_double_flow = false
      end
    end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['GatewayGeneralSecurityProfile'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['GatewayGeneralSecurityProfile'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_double_flow == o.enable_double_flow
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, enable_double_flow].hash
    end
