...
module NSXT
  class FieldsPacketData
    ...
    # The IPv6 header
    attr_accessor :ipv6_header

    # The ARP header
    attr_accessor :arp_header
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ipv6_header')
        self.ipv6_header = attributes[:'ipv6_header']
      end

      if attributes.has_key?(:'arp_header')
        self.arp_header = attributes[:'arp_header']
      end

      if attributes.has_key?(:'transport_header')
        self.transport_header = attributes[:'transport_header']
      end

      if attributes.has_key?(:'ip_header')
        self.ip_header = attributes[:'ip_header']
      end

      if attributes.has_key?(:'eth_header')
        self.eth_header = attributes[:'eth_header']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipv6_header == o.ipv6_header &&
          arp_header == o.arp_header &&
          transport_header == o.transport_header &&
          ip_header == o.ip_header &&
          eth_header == o.eth_header &&
          payload == o.payload
    end
    ...
    def hash
      [routed, transport_type, resource_type, frame_size, ipv6_header, arp_header, transport_header, ip_header, eth_header, payload].hash
    end
