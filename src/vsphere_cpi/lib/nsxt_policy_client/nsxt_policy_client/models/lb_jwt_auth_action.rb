...
module NSXT
  ...
  class LBJwtAuthAction
    ...
    attr_accessor :pass_jwt_to_pool
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pass_jwt_to_pool')
        self.pass_jwt_to_pool = attributes[:'pass_jwt_to_pool']
      else
        self.pass_jwt_to_pool = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          tokens == o.tokens &&
          pass_jwt_to_pool == o.pass_jwt_to_pool &&
          realm == o.realm &&
          key == o.key
    end
    ...
    def hash
      [type, tokens, pass_jwt_to_pool, realm, key].hash
    end
