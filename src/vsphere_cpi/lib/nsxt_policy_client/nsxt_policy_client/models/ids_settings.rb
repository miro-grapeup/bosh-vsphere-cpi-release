...
module NSXT
  ...
  class IdsSettings
    ...
    attr_accessor :ids_ever_enabled
    ...
    def self.attribute_map
      {
        ...
        :'ids_ever_enabled' => :'ids_ever_enabled'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'auto_update')
        self.auto_update = attributes[:'auto_update']
      else
        self.auto_update = false
      end

      if attributes.has_key?(:'ids_ever_enabled')
        self.ids_ever_enabled = attributes[:'ids_ever_enabled']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auto_update == o.auto_update &&
          ids_ever_enabled == o.ids_ever_enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, auto_update, ids_ever_enabled].hash
    end
