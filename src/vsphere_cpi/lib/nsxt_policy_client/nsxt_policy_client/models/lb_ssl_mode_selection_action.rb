...
module NSXT
  ...
  class LBSslModeSelectionAction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ssl_mode')
        self.ssl_mode = attributes[:'ssl_mode']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ssl_mode.nil?
        invalid_properties.push('invalid value for "ssl_mode", ssl_mode cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ssl_mode.nil?
      ssl_mode_validator = EnumAttributeValidator.new('String', ['SSL_PASSTHROUGH', 'SSL_END_TO_END', 'SSL_OFFLOAD'])
      return false unless ssl_mode_validator.valid?(@ssl_mode)
      true
    end
    ...
    def ssl_mode=(ssl_mode)
      validator = EnumAttributeValidator.new('String', ['SSL_PASSTHROUGH', 'SSL_END_TO_END', 'SSL_OFFLOAD'])
      unless validator.valid?(ssl_mode)
        fail ArgumentError, 'invalid value for "ssl_mode", must be one of #{validator.allowable_values}.'
      end
      @ssl_mode = ssl_mode
    end
