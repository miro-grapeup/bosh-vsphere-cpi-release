...
module NSXT
  ...
  class ChildIdsProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IdsProfile')
        self.ids_profile = attributes[:'IdsProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ids_profile.nil?
        invalid_properties.push('invalid value for "ids_profile", ids_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, ids_profile].hash
    end
