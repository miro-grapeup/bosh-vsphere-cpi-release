...
module NSXT
  class MulticastRouteCsvRecord
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'input_interface')
        self.input_interface = attributes[:'input_interface']
      end
      ...
      if attributes.has_key?(:'output_interface')
        self.output_interface = attributes[:'output_interface']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          group == o.group &&
          ttl == o.ttl &&
          input_interface == o.input_interface &&
          source_address == o.source_address &&
          output_interface == o.output_interface
    end
    ...
    def hash
      [transport_node, uptime, group, ttl, input_interface, source_address, output_interface].hash
    end
