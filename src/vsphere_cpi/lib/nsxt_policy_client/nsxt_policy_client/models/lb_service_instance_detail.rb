...
module NSXT
  class LBServiceInstanceDetail
    ...
    attr_accessor :attachment_display_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'attachment_path')
        self.attachment_path = attributes[:'attachment_path']
      end

      if attributes.has_key?(:'attachment_display_name')
        self.attachment_display_name = attributes[:'attachment_display_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          attachment_display_name == o.attachment_display_name &&
    ...
    def hash
      [attachment_path, attachment_display_name, error_message].hash
    end
