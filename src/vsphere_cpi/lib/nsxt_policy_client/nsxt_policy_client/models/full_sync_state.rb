...
module NSXT
  ...
  class FullSyncState
    ...
    attr_accessor :last_completed_stage
    ...
    def self.attribute_map
      {
        ...
        :'last_upate_time' => :'last_upate_time',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'last_upate_time')
        self.last_upate_time = attributes[:'last_upate_time']
      end
      ...
      if attributes.has_key?(:'last_completed_stage')
        self.last_completed_stage = attributes[:'last_completed_stage']
      end

      if attributes.has_key?(:'full_sync_id')
        self.full_sync_id = attributes[:'full_sync_id']
      end
    end
    ...
    def valid?
      ...
      last_completed_stage_validator = EnumAttributeValidator.new('String', ['INITIAL', 'PAUSE_DCNS', 'DELETED_STALE_ENTITIES', 'PROCESSED_FULLSYNC_DATA', 'PROCESSED_DELTAS', 'UNPAUSE_DCNS', 'COMPLETED', 'ERROR', 'ABORTED'])
      return false unless last_completed_stage_validator.valid?(@last_completed_stage)
      true
    end
    ...
    # @param [Object] last_completed_stage Object to be assigned
    def last_completed_stage=(last_completed_stage)
      validator = EnumAttributeValidator.new('String', ['INITIAL', 'PAUSE_DCNS', 'DELETED_STALE_ENTITIES', 'PROCESSED_FULLSYNC_DATA', 'PROCESSED_DELTAS', 'UNPAUSE_DCNS', 'COMPLETED', 'ERROR', 'ABORTED'])
      unless validator.valid?(last_completed_stage)
        fail ArgumentError, 'invalid value for "last_completed_stage", must be one of #{validator.allowable_values}.'
      end
      @last_completed_stage = last_completed_stage
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_upate_time == o.last_upate_time &&
          start_time == o.start_time &&
          errors == o.errors &&
          last_completed_stage == o.last_completed_stage &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, last_upate_time, start_time, errors, last_completed_stage, full_sync_id].hash
    end
