...
module NSXT
  ...
  class Condition
    ...
    def valid?
      ...
      member_type_validator = EnumAttributeValidator.new('String', ['IPSet', 'VirtualMachine', 'LogicalPort', 'LogicalSwitch', 'Segment', 'SegmentPort'])
    ...
    def member_type=(member_type)
      validator = EnumAttributeValidator.new('String', ['IPSet', 'VirtualMachine', 'LogicalPort', 'LogicalSwitch', 'Segment', 'SegmentPort'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, operator, value, key, member_type].hash
    end
