...
module NSXT
  ...
  class LiveTraceConfig
    ...
    attr_accessor :src_port_path

    # This field indicates whether the intent is transient. If it is set to true, intent will be cleaned up after 1 hour of inactivity. 
    ...
    def self.swagger_types
      {
        ...
        :'timeout' => :'Integer',
        :'src_port_path' => :'String',
        :'is_transient' => :'BOOLEAN',
        :'actions' => :'PolicyLiveTraceActionConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'src_port_path')
        self.src_port_path = attributes[:'src_port_path']
      end
    ...
    def list_invalid_properties
      ...
      if !@timeout.nil? && @timeout > 300
        invalid_properties.push('invalid value for "timeout", must be smaller than or equal to 300.')
      end
      ...
      if @src_port_path.nil?
        invalid_properties.push('invalid value for "src_port_path", src_port_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@timeout.nil? && @timeout > 300
      return false if !@timeout.nil? && @timeout < 5
      return false if @src_port_path.nil?
    ...
    def timeout=(timeout)
      if !timeout.nil? && timeout > 300
        fail ArgumentError, 'invalid value for "timeout", must be smaller than or equal to 300.'
      end
