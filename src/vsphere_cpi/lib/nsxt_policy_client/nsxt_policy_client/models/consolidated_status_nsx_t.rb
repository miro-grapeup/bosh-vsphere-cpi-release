...
module NSXT
  ...
  class ConsolidatedStatusNsxT
    ...
    def self.swagger_types
      {
        ...
        :'enforced_status' => :'EnforcedStatusDetailsNsxT'
      }
    end
    ...
    def hash
      [alarm, enforcement_point_path, site_path, consolidated_status, resource_type, enforcement_point_id, enforced_status].hash
    end
