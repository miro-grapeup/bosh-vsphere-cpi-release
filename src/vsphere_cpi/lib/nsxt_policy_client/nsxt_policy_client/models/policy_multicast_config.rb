...
module NSXT
  ...
  class PolicyMulticastConfig
    ...
    def self.attribute_map
      {
        ...
        :'replication_multicast_range' => :'replication_multicast_range',
        :'igmp_profile_path' => :'igmp_profile_path',
        :'pim_profile_path' => :'pim_profile_path',
        :'enabled' => :'enabled'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'replication_multicast_range' => :'String',
        :'igmp_profile_path' => :'String',
        :'pim_profile_path' => :'String',
        :'enabled' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'replication_multicast_range')
        self.replication_multicast_range = attributes[:'replication_multicast_range']
      end

      if attributes.has_key?(:'igmp_profile_path')
        self.igmp_profile_path = attributes[:'igmp_profile_path']
      end

      if attributes.has_key?(:'pim_profile_path')
        self.pim_profile_path = attributes[:'pim_profile_path']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          replication_multicast_range == o.replication_multicast_range &&
          igmp_profile_path == o.igmp_profile_path &&
          pim_profile_path == o.pim_profile_path &&
          enabled == o.enabled
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, replication_multicast_range, igmp_profile_path, pim_profile_path, enabled].hash
    end
