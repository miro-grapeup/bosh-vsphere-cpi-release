...
module NSXT
  ...
  class SegmentSecurityProfile
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, bpdu_filter_enable, ra_guard_enabled, dhcp_client_block_v6_enabled, non_ip_traffic_block_enabled, bpdu_filter_allow, dhcp_server_block_enabled, rate_limits_enabled, rate_limits, dhcp_client_block_enabled, dhcp_server_block_v6_enabled].hash
    end
