...
module NSXT
  ...
  class PolicyFirewallCPUMemThresholdsProfileBindingMap
    ...
    def self.swagger_types
      {
        ...
        :'transport_nodes' => :'Array<PolicyResourceReference>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @sequence_number > 4294967295
        invalid_properties.push('invalid value for "sequence_number", must be smaller than or equal to 4294967295.')
      end
    ...
    def valid?
      ...
      return false if @sequence_number > 4294967295
      return false if @sequence_number < 0
      true
    end
    ...
    def sequence_number=(sequence_number)
      ...
      if sequence_number > 4294967295
        fail ArgumentError, 'invalid value for "sequence_number", must be smaller than or equal to 4294967295.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, profile_path, sequence_number, transport_nodes].hash
    end
