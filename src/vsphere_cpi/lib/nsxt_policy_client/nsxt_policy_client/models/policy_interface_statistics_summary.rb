...
module NSXT
  ...
  class PolicyInterfaceStatisticsSummary
    ...
    attr_accessor :interface_policy_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'interface_policy_path')
        self.interface_policy_path = attributes[:'interface_policy_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          interface_policy_path == o.interface_policy_path
    end
    ...
    def hash
      [last_update_timestamp, rx, tx, logical_router_port_id, interface_policy_path].hash
    end
