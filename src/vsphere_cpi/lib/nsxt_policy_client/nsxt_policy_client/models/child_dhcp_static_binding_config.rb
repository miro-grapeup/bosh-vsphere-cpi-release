...
module NSXT
  ...
  class ChildDhcpStaticBindingConfig
    ...
    attr_accessor :dhcp_static_binding_config
    ...
    def self.attribute_map
      {
        ...
        :'dhcp_static_binding_config' => :'DhcpStaticBindingConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DhcpStaticBindingConfig')
        self.dhcp_static_binding_config = attributes[:'DhcpStaticBindingConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dhcp_static_binding_config.nil?
        invalid_properties.push('invalid value for "dhcp_static_binding_config", dhcp_static_binding_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dhcp_static_binding_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dhcp_static_binding_config == o.dhcp_static_binding_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, dhcp_static_binding_config].hash
    end
