...
module NSXT
  ...
  class ChildLiveTraceConfig
    ...
    attr_accessor :live_trace_config
    ...
    def self.attribute_map
      {
        ...
        :'live_trace_config' => :'LiveTraceConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LiveTraceConfig')
        self.live_trace_config = attributes[:'LiveTraceConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @live_trace_config.nil?
        invalid_properties.push('invalid value for "live_trace_config", live_trace_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @live_trace_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          live_trace_config == o.live_trace_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, live_trace_config].hash
    end
