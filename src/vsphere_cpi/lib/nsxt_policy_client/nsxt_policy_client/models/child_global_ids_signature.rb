...
module NSXT
  ...
  class ChildGlobalIdsSignature
    ...
    attr_accessor :global_ids_signature
    ...
    def self.attribute_map
      {
        ...
        :'global_ids_signature' => :'GlobalIdsSignature'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GlobalIdsSignature')
        self.global_ids_signature = attributes[:'GlobalIdsSignature']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @global_ids_signature.nil?
        invalid_properties.push('invalid value for "global_ids_signature", global_ids_signature cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @global_ids_signature.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          global_ids_signature == o.global_ids_signature
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, global_ids_signature].hash
    end
