...
module NSXT
  ...
  class NestedServiceServiceEntry
    ...
    attr_accessor :nested_service_path
    ...
    def self.attribute_map
      {
        ...
        :'nested_service_path' => :'nested_service_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nested_service_path')
        self.nested_service_path = attributes[:'nested_service_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @nested_service_path.nil?
        invalid_properties.push('invalid value for "nested_service_path", nested_service_path cannot be nil.')
      end
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['IPProtocolServiceEntry', 'IGMPTypeServiceEntry', 'ICMPTypeServiceEntry', 'ALGTypeServiceEntry', 'L4PortSetServiceEntry', 'EtherTypeServiceEntry', 'NestedServiceServiceEntry'])
      return false unless resource_type_validator.valid?(@resource_type)
      return false if @nested_service_path.nil?
      true
    end
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['IPProtocolServiceEntry', 'IGMPTypeServiceEntry', 'ICMPTypeServiceEntry', 'ALGTypeServiceEntry', 'L4PortSetServiceEntry', 'EtherTypeServiceEntry', 'NestedServiceServiceEntry'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nested_service_path == o.nested_service_path
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, nested_service_path].hash
    end
