...
module NSXT
  ...
  class StaticRoutes
    ...
    attr_accessor :enabled_on_secondary
    ...
    def self.attribute_map
      {
        ...
        :'next_hops' => :'next_hops',
        :'network' => :'network',
        :'enabled_on_secondary' => :'enabled_on_secondary'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enabled_on_secondary')
        self.enabled_on_secondary = attributes[:'enabled_on_secondary']
      else
        self.enabled_on_secondary = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          network == o.network &&
          enabled_on_secondary == o.enabled_on_secondary
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, next_hops, network, enabled_on_secondary].hash
    end
