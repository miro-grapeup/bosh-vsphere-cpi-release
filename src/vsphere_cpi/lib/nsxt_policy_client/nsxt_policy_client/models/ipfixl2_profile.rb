...
module NSXT
  ...
  class IPFIXL2Profile
    ...
    attr_accessor :export_overlay_flow
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'export_overlay_flow')
        self.export_overlay_flow = attributes[:'export_overlay_flow']
      else
        self.export_overlay_flow = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          export_overlay_flow == o.export_overlay_flow &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, priority, idle_timeout, ipfix_collector_profile_path, max_flows, observation_domain_id, active_timeout, export_overlay_flow, packet_sample_probability].hash
    end
