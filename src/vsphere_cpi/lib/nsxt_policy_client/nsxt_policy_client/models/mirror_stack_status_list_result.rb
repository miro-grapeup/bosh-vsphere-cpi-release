...
module NSXT
  class MirrorStackStatusListResult
    ...
    def self.swagger_types
      {
        ...
        :'results' => :'Array<TnNodeStackSpanStatus>'
      }
    end
    ...
    def valid?
      ...
      overall_status_validator = EnumAttributeValidator.new('String', ['UNKNOWN', 'SUCCESS', 'FAILED'])
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, overall_status, results].hash
    end
