...
module NSXT
  ...
  class BfdProfile
    ...
    def list_invalid_properties
      ...
      if !@interval.nil? && @interval < 50
        invalid_properties.push('invalid value for "interval", must be greater than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if !@interval.nil? && @interval < 50
    ...
    def interval=(interval)
      ...
      if !interval.nil? && interval < 50
        fail ArgumentError, 'invalid value for "interval", must be greater than or equal to 50.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, interval, multiple].hash
    end
