...
module NSXT
  ...
  class TagInfo
    ...
    attr_accessor :tagged_objects_count
    ...
    def self.attribute_map
      {
        :'scope' => :'scope',
        :'tag' => :'tag',
        :'tagged_objects_count' => :'tagged_objects_count'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tagged_objects_count')
        self.tagged_objects_count = attributes[:'tagged_objects_count']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          scope == o.scope &&
          tag == o.tag &&
          tagged_objects_count == o.tagged_objects_count
    end
    ...
    def hash
      [scope, tag, tagged_objects_count].hash
    end
