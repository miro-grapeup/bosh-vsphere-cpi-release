...
module NSXT
  ...
  class ChildL2BridgeEndpointProfile
    ...
    attr_accessor :l2_bridge_endpoint_profile
    ...
    def self.attribute_map
      {
        ...
        :'l2_bridge_endpoint_profile' => :'L2BridgeEndpointProfile'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'L2BridgeEndpointProfile')
        self.l2_bridge_endpoint_profile = attributes[:'L2BridgeEndpointProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @l2_bridge_endpoint_profile.nil?
        invalid_properties.push('invalid value for "l2_bridge_endpoint_profile", l2_bridge_endpoint_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @l2_bridge_endpoint_profile.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          l2_bridge_endpoint_profile == o.l2_bridge_endpoint_profile
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, l2_bridge_endpoint_profile].hash
    end
