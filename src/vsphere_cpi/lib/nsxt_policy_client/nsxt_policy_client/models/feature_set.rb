...
module NSXT
  ...
  class FeatureSet
    ...
    attr_accessor :require_all_permissions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'feature_list')
        if (value = attributes[:'feature_list']).is_a?(Array)
          self.feature_list = value
        end
      end

      if attributes.has_key?(:'require_all_permissions')
        self.require_all_permissions = attributes[:'require_all_permissions']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          require_all_permissions == o.require_all_permissions
    end
    ...
    def hash
      [feature_list, require_all_permissions].hash
    end
