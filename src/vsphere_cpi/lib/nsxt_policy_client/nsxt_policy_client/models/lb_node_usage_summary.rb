...
module NSXT
  ...
  class LBNodeUsageSummary
    ...
    def self.swagger_types
      {
        ...
        :'node_usages' => :'Array<LBNodeUsage>',
        :'severity' => :'String',
        :'pool_member_capacity' => :'Integer',
        :'node_counts' => :'Array<LBNodeCountPerSeverity>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'node_usages')
        if (value = attributes[:'node_usages']).is_a?(Array)
          self.node_usages = value
        end
      end
      ...
      if attributes.has_key?(:'node_counts')
        if (value = attributes[:'node_counts']).is_a?(Array)
          self.node_counts = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          node_usages == o.node_usages &&
          severity == o.severity &&
          pool_member_capacity == o.pool_member_capacity &&
          node_counts == o.node_counts &&
    ...
    def hash
      [alarm, enforcement_point_path, current_load_balancer_credits, load_balancer_credit_capacity, node_usages, severity, pool_member_capacity, node_counts, current_pool_member_count, usage_percentage].hash
    end
