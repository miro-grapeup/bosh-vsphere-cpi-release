...
module NSXT
  ...
  class GenericPolicyRealizedResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'intent_paths')
        if (value = attributes[:'intent_paths']).is_a?(Array)
          self.intent_paths = value
        end
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, realization_specific_identifier, intent_reference, state, realization_api, alarms, runtime_error, runtime_status, site_path, intent_paths, enforcement_point_path, extended_attributes, entity_type].hash
    end
