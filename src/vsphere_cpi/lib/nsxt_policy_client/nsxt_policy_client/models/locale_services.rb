...
module NSXT
  ...
  class LocaleServices
    ...
    attr_accessor :route_redistribution_config
    ...
    attr_accessor :bfd_profile_path
    ...
    def self.attribute_map
      {
        ...
        :'bfd_profile_path' => :'bfd_profile_path',
    ...
    def self.swagger_types
      {
        ...
        :'ha_vip_configs' => :'Array<Tier0HaVipConfig>',
        :'route_redistribution_config' => :'Tier0RouteRedistributionConfig',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'route_redistribution_config')
        self.route_redistribution_config = attributes[:'route_redistribution_config']
      end
      ...
      if attributes.has_key?(:'bfd_profile_path')
        self.bfd_profile_path = attributes[:'bfd_profile_path']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          route_redistribution_config == o.route_redistribution_config &&
          edge_cluster_path == o.edge_cluster_path &&
          bfd_profile_path == o.bfd_profile_path &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, preferred_edge_paths, ha_vip_configs, route_redistribution_config, edge_cluster_path, bfd_profile_path, route_redistribution_types].hash
    end
