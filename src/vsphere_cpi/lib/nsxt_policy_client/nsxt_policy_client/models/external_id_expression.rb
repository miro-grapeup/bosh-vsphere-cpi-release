...
module NSXT
  ...
  class ExternalIDExpression
    ...
    def valid?
      ...
      member_type_validator = EnumAttributeValidator.new('String', ['VirtualMachine', 'VirtualNetworkInterface', 'CloudNativeServiceInstance', 'PhysicalServer'])
    ...
    def member_type=(member_type)
      validator = EnumAttributeValidator.new('String', ['VirtualMachine', 'VirtualNetworkInterface', 'CloudNativeServiceInstance', 'PhysicalServer'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, external_ids, member_type].hash
    end
