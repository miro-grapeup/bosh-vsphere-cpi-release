...
module NSXT
  ...
  class SecurityZoneBinding
    ...
    attr_accessor :security_zone_path
    ...
    def self.attribute_map
      {
        ...
        :'security_zone_path' => :'security_zone_path'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'security_zone_path')
        self.security_zone_path = attributes[:'security_zone_path']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @security_zone_path.nil?
        invalid_properties.push('invalid value for "security_zone_path", security_zone_path cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_zone_path.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          security_zone_path == o.security_zone_path
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, security_zone_path].hash
    end
