...
module NSXT
  ...
  class PolicyNat
    ...
    def valid?
      ...
      nat_type_validator = EnumAttributeValidator.new('String', ['INTERNAL', 'USER', 'DEFAULT', 'NAT64'])
    ...
    def nat_type=(nat_type)
      validator = EnumAttributeValidator.new('String', ['INTERNAL', 'USER', 'DEFAULT', 'NAT64'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, nat_type].hash
    end
