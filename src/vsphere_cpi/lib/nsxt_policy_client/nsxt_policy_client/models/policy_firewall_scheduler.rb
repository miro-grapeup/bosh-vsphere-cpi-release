...
module NSXT
  ...
  class PolicyFirewallScheduler
    ...
    def self.swagger_types
      {
        ...
        :'time_interval' => :'Array<PolicyTimeIntervalValue>',
        :'end_time' => :'String',
        :'end_date' => :'String',
        :'timezone' => :'String',
        :'start_time' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'time_interval')
        if (value = attributes[:'time_interval']).is_a?(Array)
    ...
    def valid?
      ...
      timezone_validator = EnumAttributeValidator.new('String', ['UTC', 'LOCAL'])
    ...
    def timezone=(timezone)
      validator = EnumAttributeValidator.new('String', ['UTC', 'LOCAL'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, time_interval, end_time, end_date, timezone, start_time, recurring, days, start_date].hash
    end
