...
module NSXT
  ...
  class ChildBfdProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BfdProfile')
        self.bfd_profile = attributes[:'BfdProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bfd_profile.nil?
        invalid_properties.push('invalid value for "bfd_profile", bfd_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bfd_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, bfd_profile].hash
    end
