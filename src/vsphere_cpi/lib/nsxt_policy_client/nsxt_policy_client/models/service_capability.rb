...
module NSXT
  ...
  class ServiceCapability
    ...
    attr_accessor :nsh_liveness_support_enabled
    ...
    def self.swagger_types
      {
        :'nsh_liveness_support_enabled' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nsh_liveness_support_enabled')
        self.nsh_liveness_support_enabled = attributes[:'nsh_liveness_support_enabled']
      else
        self.nsh_liveness_support_enabled = false
      end

      if attributes.has_key?(:'can_decrement_si')
        self.can_decrement_si = attributes[:'can_decrement_si']
      else
        self.can_decrement_si = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          nsh_liveness_support_enabled == o.nsh_liveness_support_enabled &&
    ...
    def hash
      [nsh_liveness_support_enabled, can_decrement_si].hash
    end
