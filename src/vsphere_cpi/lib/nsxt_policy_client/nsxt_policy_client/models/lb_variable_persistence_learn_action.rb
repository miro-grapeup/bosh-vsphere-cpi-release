...
module NSXT
  ...
  class LBVariablePersistenceLearnAction
    ...
    attr_accessor :persistence_profile_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'persistence_profile_path')
        self.persistence_profile_path = attributes[:'persistence_profile_path']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          persistence_profile_path == o.persistence_profile_path
    end
    ...
    def hash
      [type, variable_hash_enabled, variable_name, persistence_profile_path].hash
    end
