...
module NSXT
  ...
  class ChildPolicyExcludeList
    ...
    attr_accessor :policy_exclude_list
    ...
    def self.attribute_map
      {
        ...
        :'policy_exclude_list' => :'PolicyExcludeList'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyExcludeList')
        self.policy_exclude_list = attributes[:'PolicyExcludeList']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_exclude_list.nil?
        invalid_properties.push('invalid value for "policy_exclude_list", policy_exclude_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_exclude_list.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_exclude_list == o.policy_exclude_list
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_exclude_list].hash
    end
