...
module NSXT
  class LiveTraceStatus
    ...
    def valid?
      ...
      operation_state_validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'FINISHED', 'PARTIAL_FINISHED', 'CANCELED', 'TIMEOUT'])
    ...
    def operation_state=(operation_state)
      validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'FINISHED', 'PARTIAL_FINISHED', 'CANCELED', 'TIMEOUT'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, filter, operation_state, timeout, source_lport, request_status, actions].hash
    end
