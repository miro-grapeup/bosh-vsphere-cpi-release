...
module NSXT
  ...
  class ChildSecurityZoneRule
    ...
    attr_accessor :security_zone_rule
    ...
    def self.attribute_map
      {
        ...
        :'security_zone_rule' => :'SecurityZoneRule'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SecurityZoneRule')
        self.security_zone_rule = attributes[:'SecurityZoneRule']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @security_zone_rule.nil?
        invalid_properties.push('invalid value for "security_zone_rule", security_zone_rule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_zone_rule.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          security_zone_rule == o.security_zone_rule
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, security_zone_rule].hash
    end
