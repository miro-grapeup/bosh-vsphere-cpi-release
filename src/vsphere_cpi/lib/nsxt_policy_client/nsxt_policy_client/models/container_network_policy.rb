...
module NSXT
  ...
  class ContainerNetworkPolicy
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, network_status, container_cluster_id, policy_type, origin_properties, external_id, container_project_id, network_errors, spec].hash
    end
