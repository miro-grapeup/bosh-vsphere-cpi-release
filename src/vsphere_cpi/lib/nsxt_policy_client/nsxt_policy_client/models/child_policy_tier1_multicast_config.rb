...
module NSXT
  ...
  class ChildPolicyTier1MulticastConfig
    ...
    attr_accessor :policy_tier1_multicast_config
    ...
    def self.attribute_map
      {
        ...
        :'policy_tier1_multicast_config' => :'PolicyTier1MulticastConfig'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PolicyTier1MulticastConfig')
        self.policy_tier1_multicast_config = attributes[:'PolicyTier1MulticastConfig']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_tier1_multicast_config.nil?
        invalid_properties.push('invalid value for "policy_tier1_multicast_config", policy_tier1_multicast_config cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_tier1_multicast_config.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          policy_tier1_multicast_config == o.policy_tier1_multicast_config
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, policy_tier1_multicast_config].hash
    end
