...
module NSXT
  ...
  class DistributedVirtualPortgroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'backing_type')
        self.backing_type = attributes[:'backing_type']
      end
    ...
    def valid?
      ...
      overall_status_validator = EnumAttributeValidator.new('String', ['RED', 'YELLOW', 'GREEN', 'GRAY'])
    ...
    def overall_status=(overall_status)
      validator = EnumAttributeValidator.new('String', ['RED', 'YELLOW', 'GREEN', 'GRAY'])
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, external_id, origin_type, cm_local_id, overall_status, backing_type, key].hash
    end
