...
module NSXT
  ...
  class EndpointRule
    ...
    def list_invalid_properties
      ...
      if !@sequence_number.nil? && @sequence_number > 499
        invalid_properties.push('invalid value for "sequence_number", must be smaller than or equal to 499.')
      end
    ...
    def valid?
      ...
      return false if !@sequence_number.nil? && @sequence_number > 499
    ...
    def sequence_number=(sequence_number)
      if !sequence_number.nil? && sequence_number > 499
        fail ArgumentError, 'invalid value for "sequence_number", must be smaller than or equal to 499.'
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, service_profiles, groups, sequence_number].hash
    end
