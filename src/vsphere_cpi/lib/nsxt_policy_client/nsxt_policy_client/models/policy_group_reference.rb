...
module NSXT
  ...
  class PolicyGroupReference
    ...
    def list_invalid_properties
      ...
      if @refs.nil?
        invalid_properties.push('invalid value for "refs", refs cannot be nil.')
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, refs].hash
    end
