...
module NSXT
  ...
  class SegmentPort
    ...
    attr_accessor :ignored_address_bindings
    ...
    def self.swagger_types
      {
        ...
        :'ignored_address_bindings' => :'Array<PortAddressBindingEntry>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ignored_address_bindings')
        if (value = attributes[:'ignored_address_bindings']).is_a?(Array)
          self.ignored_address_bindings = value
        end
      end
      ...
      if attributes.has_key?(:'source_site_id')
        self.source_site_id = attributes[:'source_site_id']
      end
    end
    ...
    def valid?
      ...
      init_state_validator = EnumAttributeValidator.new('String', ['UNBLOCKED_VLAN', 'RESTORE_VIF'])
    ...
    def init_state=(init_state)
      validator = EnumAttributeValidator.new('String', ['UNBLOCKED_VLAN', 'RESTORE_VIF'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignored_address_bindings == o.ignored_address_bindings &&
          address_bindings == o.address_bindings &&
          source_site_id == o.source_site_id
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, init_state, admin_state, attachment, extra_configs, ignored_address_bindings, address_bindings, source_site_id].hash
    end
