  ...
  class L2BridgeEndpointProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ha_mode')
        ...
        self.ha_mode = 'ACTIVE_STANDBY'
      end

      if attributes.has_key?(:'edge_paths')
        if (value = attributes[:'edge_paths']).is_a?(Array)
          self.edge_paths = value
        end
      end
    end
    ...
    def valid?
      ...
      ha_mode_validator = EnumAttributeValidator.new('String', ['ACTIVE_STANDBY'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, failover_mode, ha_mode, edge_paths].hash
    end
