...
module NSXT
  ...
  class LBService
    ...
    attr_accessor :relax_scale_validation
    ...
    def self.swagger_types
      {
        ...
        :'relax_scale_validation' => :'BOOLEAN',
        :'enabled' => :'BOOLEAN',
        :'size' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relax_scale_validation')
        self.relax_scale_validation = attributes[:'relax_scale_validation']
      else
        self.relax_scale_validation = false
      end
    ...
    def valid?
      ...
      size_validator = EnumAttributeValidator.new('String', ['SMALL', 'MEDIUM', 'LARGE', 'XLARGE', 'DLB'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          relax_scale_validation == o.relax_scale_validation &&
          enabled == o.enabled &&
          size == o.size
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, path, parent_path, unique_id, relative_path, children, overridden, marked_for_delete, access_log_enabled, connectivity_path, error_log_level, relax_scale_validation, enabled, size].hash
    end
