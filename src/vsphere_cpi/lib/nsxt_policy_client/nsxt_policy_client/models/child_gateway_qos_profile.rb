  ...
  class ChildGatewayQosProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'QosProfile')
        self.qos_profile = attributes[:'QosProfile']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @qos_profile.nil?
        invalid_properties.push('invalid value for "qos_profile", qos_profile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @qos_profile.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, mark_for_override, marked_for_delete, qos_profile].hash
    end
