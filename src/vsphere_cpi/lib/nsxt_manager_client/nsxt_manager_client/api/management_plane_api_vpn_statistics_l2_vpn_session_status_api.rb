...
module NSXT
  class ManagementPlaneApiVpnStatisticsL2VpnSessionStatusApi
    ...
    def get_l2_vpn_session_status_with_http_info(session_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiVpnStatisticsL2VpnSessionStatusApi.get_l2_vpn_session_status ...'
      end
      # verify the required parameter 'session_id' is set
      if @api_client.config.client_side_validation && session_id.nil?
        fail ArgumentError, "Missing the required parameter 'session_id' when calling ManagementPlaneApiVpnStatisticsL2VpnSessionStatusApi.get_l2_vpn_session_status"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ManagementPlaneApiVpnStatisticsL2VpnSessionStatusApi#get_l2_vpn_session_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
