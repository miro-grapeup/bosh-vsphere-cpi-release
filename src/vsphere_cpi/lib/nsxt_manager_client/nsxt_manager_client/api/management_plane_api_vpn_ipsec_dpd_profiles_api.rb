  ...
  class ManagementPlaneApiVpnIpsecDpdProfilesApi
    ...
    def create_ip_sec_vpndpd_profile_with_http_info(ip_sec_vpndpd_profile, opts = {})
      ...
      if @api_client.config.client_side_validation && ip_sec_vpndpd_profile.nil?
        fail ArgumentError, "Missing the required parameter 'ip_sec_vpndpd_profile' when calling ManagementPlaneApiVpnIpsecDpdProfilesApi.create_ip_sec_vpndpd_profile"
      end
      # resource path
    ...
    def list_ip_sec_vpndpd_profiles_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiVpnIpsecDpdProfilesApi.list_ip_sec_vpndpd_profiles, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiVpnIpsecDpdProfilesApi.list_ip_sec_vpndpd_profiles, must be greater than or equal to 0.'
      end
    ...
    def update_ip_sec_vpndpd_profile_with_http_info(ipsec_vpn_dpd_profile_id, ip_sec_vpndpd_profile, opts = {})
      ...
      # verify the required parameter 'ip_sec_vpndpd_profile' is set
      if @api_client.config.client_side_validation && ip_sec_vpndpd_profile.nil?
        fail ArgumentError, "Missing the required parameter 'ip_sec_vpndpd_profile' when calling ManagementPlaneApiVpnIpsecDpdProfilesApi.update_ip_sec_vpndpd_profile"
      end
      # resource path
      local_var_path = '/vpn/ipsec/dpd-profiles/{ipsec-vpn-dpd-profile-id}'.sub('{' + 'ipsec-vpn-dpd-profile-id' + '}', ipsec_vpn_dpd_profile_id.to_s)
