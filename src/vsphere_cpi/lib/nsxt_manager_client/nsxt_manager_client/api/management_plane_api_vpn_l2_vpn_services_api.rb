  ...
  class ManagementPlaneApiVpnL2VpnServicesApi
    ...
    def list_l2_vpn_services_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiVpnL2VpnServicesApi.list_l2_vpn_services, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiVpnL2VpnServicesApi.list_l2_vpn_services, must be greater than or equal to 0.'
      end
    ...
    def update_l2_vpn_service_with_http_info(l2vpn_service_id, l2_vpn_service, opts = {})
      ...
      # verify the required parameter 'l2_vpn_service' is set
      if @api_client.config.client_side_validation && l2_vpn_service.nil?
        fail ArgumentError, "Missing the required parameter 'l2_vpn_service' when calling ManagementPlaneApiVpnL2VpnServicesApi.update_l2_vpn_service"
      end
      # resource path
      local_var_path = '/vpn/l2vpn/services/{l2vpn-service-id}'.sub('{' + 'l2vpn-service-id' + '}', l2vpn_service_id.to_s)
