  ...
  class ManagementPlaneApiVpnIpsecPeerEndpointsApi
    ...
    def list_ip_sec_vpn_peer_endpoints_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiVpnIpsecPeerEndpointsApi.list_ip_sec_vpn_peer_endpoints, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiVpnIpsecPeerEndpointsApi.list_ip_sec_vpn_peer_endpoints, must be greater than or equal to 0.'
      end
    ...
    def update_ip_sec_vpn_peer_endpoint_with_http_info(ipsec_vpn_peer_endpoint_id, ip_sec_vpn_peer_endpoint, opts = {})
      ...
      # verify the required parameter 'ip_sec_vpn_peer_endpoint' is set
      if @api_client.config.client_side_validation && ip_sec_vpn_peer_endpoint.nil?
        fail ArgumentError, "Missing the required parameter 'ip_sec_vpn_peer_endpoint' when calling ManagementPlaneApiVpnIpsecPeerEndpointsApi.update_ip_sec_vpn_peer_endpoint"
      end
      # resource path
      local_var_path = '/vpn/ipsec/peer-endpoints/{ipsec-vpn-peer-endpoint-id}'.sub('{' + 'ipsec-vpn-peer-endpoint-id' + '}', ipsec_vpn_peer_endpoint_id.to_s)
