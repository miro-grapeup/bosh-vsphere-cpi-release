  ...
  class ManagementPlaneApiAppDiscoveryApi
    ...
    def add_app_profile_with_http_info(app_profile, opts = {})
      ...
      if @api_client.config.client_side_validation && app_profile.nil?
        fail ArgumentError, "Missing the required parameter 'app_profile' when calling ManagementPlaneApiAppDiscoveryApi.add_app_profile"
      end
      # resource path
    ...
    def get_app_discovery_session_app_profiles_with_http_info(session_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_app_profiles, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_app_profiles, must be greater than or equal to 0.'
      end
    ...
    def get_app_discovery_session_installed_apps_with_http_info(session_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_installed_apps, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_installed_apps, must be greater than or equal to 0.'
      end
    ...
    def get_app_discovery_session_ns_group_members_with_http_info(session_id, ns_group_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_ns_group_members, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_ns_group_members, must be greater than or equal to 0.'
      end
    ...
    def get_app_discovery_session_ns_groups_with_http_info(session_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_ns_groups, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_session_ns_groups, must be greater than or equal to 0.'
      end
    ...
    def get_app_discovery_sessions_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_sessions, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiAppDiscoveryApi.get_app_discovery_sessions, must be greater than or equal to 0.'
      end
    ...
    def get_appdiscovery_result_app_info_and_host_vm_in_csv_format_csv_with_http_info(session_id, report_app_results_for_vms_request_parameters, opts = {})
      ...
      if @api_client.config.client_side_validation && report_app_results_for_vms_request_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'report_app_results_for_vms_request_parameters' when calling ManagementPlaneApiAppDiscoveryApi.get_appdiscovery_result_app_info_and_host_vm_in_csv_format_csv"
      end
      # resource path
    ...
    def reclassify_app_discovery_session_with_http_info(session_id, session_reclassification_parameter, opts = {})
      ...
      if @api_client.config.client_side_validation && session_reclassification_parameter.nil?
        fail ArgumentError, "Missing the required parameter 'session_reclassification_parameter' when calling ManagementPlaneApiAppDiscoveryApi.reclassify_app_discovery_session"
      end
      # resource path
    ...
    def start_app_discovery_session_with_http_info(start_app_discovery_session_parameters, opts = {})
      ...
      if @api_client.config.client_side_validation && start_app_discovery_session_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'start_app_discovery_session_parameters' when calling ManagementPlaneApiAppDiscoveryApi.start_app_discovery_session"
      end
      # resource path
      local_var_path = '/app-discovery/sessions'
    ...
    def update_app_profile_with_http_info(app_profile_id, app_profile, opts = {})
      ...
      # verify the required parameter 'app_profile' is set
      if @api_client.config.client_side_validation && app_profile.nil?
        fail ArgumentError, "Missing the required parameter 'app_profile' when calling ManagementPlaneApiAppDiscoveryApi.update_app_profile"
      end
      # resource path
      local_var_path = '/app-discovery/app-profiles/{app-profile-id}'.sub('{' + 'app-profile-id' + '}', app_profile_id.to_s)
