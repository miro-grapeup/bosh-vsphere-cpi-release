...
module NSXT
  class ManagementPlaneApiNormalizationApi
    ...
    def get_normalizations_with_http_info(preferred_normalization_type, resource_id, resource_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiNormalizationApi.get_normalizations ...'
      end
      ...
      if @api_client.config.client_side_validation && preferred_normalization_type.nil?
        fail ArgumentError, "Missing the required parameter 'preferred_normalization_type' when calling ManagementPlaneApiNormalizationApi.get_normalizations"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && resource_id.nil?
        fail ArgumentError, "Missing the required parameter 'resource_id' when calling ManagementPlaneApiNormalizationApi.get_normalizations"
      end
      # verify the required parameter 'resource_type' is set
      if @api_client.config.client_side_validation && resource_type.nil?
        fail ArgumentError, "Missing the required parameter 'resource_type' when calling ManagementPlaneApiNormalizationApi.get_normalizations"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiNormalizationApi.get_normalizations, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiNormalizationApi.get_normalizations, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ManagementPlaneApiNormalizationApi#get_normalizations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
