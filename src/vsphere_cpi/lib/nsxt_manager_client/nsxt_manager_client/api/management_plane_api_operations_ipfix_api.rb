  ...
  class ManagementPlaneApiOperationsIpfixApi
    ...
    def create_ipfix_collector_config_with_http_info(ipfix_collector_config, opts = {})
      ...
      if @api_client.config.client_side_validation && ipfix_collector_config.nil?
        fail ArgumentError, "Missing the required parameter 'ipfix_collector_config' when calling ManagementPlaneApiOperationsIpfixApi.create_ipfix_collector_config"
      end
      # resource path
    ...
    def create_ipfix_config_with_http_info(ipfix_config, opts = {})
      ...
      if @api_client.config.client_side_validation && ipfix_config.nil?
        fail ArgumentError, "Missing the required parameter 'ipfix_config' when calling ManagementPlaneApiOperationsIpfixApi.create_ipfix_config"
      end
      # resource path
    ...
    def list_ipfix_collector_config_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiOperationsIpfixApi.list_ipfix_collector_config, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiOperationsIpfixApi.list_ipfix_collector_config, must be greater than or equal to 0.'
      end
    ...
    def list_ipfix_config_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiOperationsIpfixApi.list_ipfix_config, must be smaller than or equal to 1000.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 0
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling ManagementPlaneApiOperationsIpfixApi.list_ipfix_config, must be greater than or equal to 0.'
      end
    ...
    def update_ipfix_collector_config_with_http_info(collector_config_id, ipfix_collector_config, opts = {})
      ...
      # verify the required parameter 'ipfix_collector_config' is set
      if @api_client.config.client_side_validation && ipfix_collector_config.nil?
        fail ArgumentError, "Missing the required parameter 'ipfix_collector_config' when calling ManagementPlaneApiOperationsIpfixApi.update_ipfix_collector_config"
      end
      # resource path
      local_var_path = '/ipfix/collectorconfigs/{collector-config-id}'.sub('{' + 'collector-config-id' + '}', collector_config_id.to_s)
    ...
    def update_ipfix_config_with_http_info(config_id, ipfix_config, opts = {})
      ...
      # verify the required parameter 'ipfix_config' is set
      if @api_client.config.client_side_validation && ipfix_config.nil?
        fail ArgumentError, "Missing the required parameter 'ipfix_config' when calling ManagementPlaneApiOperationsIpfixApi.update_ipfix_config"
      end
      # resource path
      local_var_path = '/ipfix/configs/{config-id}'.sub('{' + 'config-id' + '}', config_id.to_s)
