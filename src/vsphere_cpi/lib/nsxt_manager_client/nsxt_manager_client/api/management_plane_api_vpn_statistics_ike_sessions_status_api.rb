...
module NSXT
  class ManagementPlaneApiVpnStatisticsIkeSessionsStatusApi
    ...
    def get_ip_sec_vpnike_session_status_with_http_info(session_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementPlaneApiVpnStatisticsIkeSessionsStatusApi.get_ip_sec_vpnike_session_status ...'
      end
      # verify the required parameter 'session_id' is set
      if @api_client.config.client_side_validation && session_id.nil?
        fail ArgumentError, "Missing the required parameter 'session_id' when calling ManagementPlaneApiVpnStatisticsIkeSessionsStatusApi.get_ip_sec_vpnike_session_status"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ManagementPlaneApiVpnStatisticsIkeSessionsStatusApi#get_ip_sec_vpnike_session_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
