...
module NSXT
  class LogicalRouterUpLinkPort
    ...
    attr_accessor :ndra_prefix_config
    ...
    def self.swagger_types
      {
        ...
        :'urpf_mode' => :'String',
        :'mac_address' => :'String',
        :'ndra_prefix_config' => :'Array<NDRAPrefixConfig>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ndra_prefix_config')
        if (value = attributes[:'ndra_prefix_config']).is_a?(Array)
          self.ndra_prefix_config = value
        end
      end

      if attributes.has_key?(:'ndra_profile_id')
        self.ndra_profile_id = attributes[:'ndra_profile_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ndra_prefix_config == o.ndra_prefix_config &&
          ndra_profile_id == o.ndra_profile_id &&
          mtu == o.mtu
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, logical_router_id, service_bindings, subnets, linked_logical_switch_port_id, edge_cluster_member_index, urpf_mode, mac_address, ndra_prefix_config, ndra_profile_id, mtu].hash
    end
