...
module NSXT
  class ServiceDeploymentStatus
    ...
    attr_accessor :deployment_issues
    ...
    def self.swagger_types
      {
        :'deployment_issues' => :'Array<ServiceDeploymentIssue>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deployment_issues')
        if (value = attributes[:'deployment_issues']).is_a?(Array)
          self.deployment_issues = value
        end
      end
      ...
      if attributes.has_key?(:'sva_current_version')
        self.sva_current_version = attributes[:'sva_current_version']
      end
      ...
      if attributes.has_key?(:'sva_max_available_version')
        self.sva_max_available_version = attributes[:'sva_max_available_version']
      end
    end
    ...
    def valid?
      deployment_status_validator = EnumAttributeValidator.new('String', ['UPGRADE_IN_PROGRESS', 'UPGRADE_FAILED', 'DEPLOYMENT_QUEUED', 'DEPLOYMENT_IN_PROGRESS', 'DEPLOYMENT_FAILED', 'DEPLOYMENT_SUCCESSFUL', 'UNDEPLOYMENT_QUEUED', 'UNDEPLOYMENT_IN_PROGRESS', 'UNDEPLOYMENT_FAILED', 'UNDEPLOYMENT_SUCCESSFUL', 'UPGRADE_QUEUED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          deployment_issues == o.deployment_issues &&
          last_update_timestamp == o.last_update_timestamp &&
          deployment_status == o.deployment_status &&
          sva_current_version == o.sva_current_version &&
          service_deployment_id == o.service_deployment_id &&
          sva_max_available_version == o.sva_max_available_version
    end
    ...
    def hash
      [deployment_issues, last_update_timestamp, deployment_status, sva_current_version, service_deployment_id, sva_max_available_version].hash
    end
