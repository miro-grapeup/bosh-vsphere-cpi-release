...
module NSXT
  class RemainingSupportBundleNode
    # Status of node
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ['PENDING', 'PROCESSING'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['PENDING', 'PROCESSING'])
    ...
    def hash
      [status, node_display_name, node_id].hash
    end
