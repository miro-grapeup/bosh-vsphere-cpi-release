...
module NSXT
  ...
  class ContainerIngressPolicy
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, container_cluster_id, origin_properties, external_id, container_project_id, spec].hash
    end
