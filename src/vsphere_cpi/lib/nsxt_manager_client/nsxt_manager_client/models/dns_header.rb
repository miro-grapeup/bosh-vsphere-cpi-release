...
module NSXT
  class DnsHeader
    ...
    def valid?
      address_type_validator = EnumAttributeValidator.new('String', ['V4', 'V6'])
      return false unless address_type_validator.valid?(@address_type)
      message_type_validator = EnumAttributeValidator.new('String', ['QUERY', 'RESPONSE'])
    ...
    def address_type=(address_type)
      validator = EnumAttributeValidator.new('String', ['V4', 'V6'])
    ...
    def message_type=(message_type)
      validator = EnumAttributeValidator.new('String', ['QUERY', 'RESPONSE'])
    ...
    def hash
      [address_type, message_type, address].hash
    end
