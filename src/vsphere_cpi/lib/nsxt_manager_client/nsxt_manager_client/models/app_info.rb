...
module NSXT
  ...
  class AppInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vm_ids')
        if (value = attributes[:'vm_ids']).is_a?(Array)
          self.vm_ids = value
        end
      end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, os_type, version, name, vm_ids, manufacturer].hash
    end
