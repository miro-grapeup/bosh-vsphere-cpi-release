...
module NSXT
  ...
  class ContainerApplicationInstance
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, status, container_cluster_id, cluster_node_id, external_id, origin_properties, container_application_ids, container_project_id].hash
    end
