...
module NSXT
  class UpgradeUnitGroup
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'upgrade_unit_count' => :'Integer',
        :'type' => :'String',
        :'upgrade_units' => :'Array<UpgradeUnit>',
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, enabled, upgrade_unit_count, type, upgrade_units, extended_configuration, parallel].hash
    end
