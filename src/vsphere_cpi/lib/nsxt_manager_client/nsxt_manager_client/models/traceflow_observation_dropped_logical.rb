...
module NSXT
  class TraceflowObservationDroppedLogical
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, nat_rule_id, reason, lport_id, lport_name, acl_rule_id, arp_fail_reason, component_id].hash
    end
