...
module NSXT
  class EdgeCluster
    ...
    attr_accessor :allocation_rules
    ...
    def self.swagger_types
      {
        ...
        :'allocation_rules' => :'Array<AllocationRule>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allocation_rules')
        if (value = attributes[:'allocation_rules']).is_a?(Array)
          self.allocation_rules = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allocation_rules == o.allocation_rules &&
          members == o.members &&
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, member_node_type, cluster_profile_bindings, allocation_rules, members, deployment_type].hash
    end
