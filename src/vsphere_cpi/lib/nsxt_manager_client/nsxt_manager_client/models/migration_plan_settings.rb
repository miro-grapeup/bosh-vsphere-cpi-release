...
module NSXT
  class MigrationPlanSettings
    ...
    def self.swagger_types
      {
        :'pause_after_each_group' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pause_after_each_group')
        self.pause_after_each_group = attributes[:'pause_after_each_group']
      else
        self.pause_after_each_group = false
      end

      if attributes.has_key?(:'pause_on_error')
        self.pause_on_error = attributes[:'pause_on_error']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          pause_after_each_group == o.pause_after_each_group &&
    ...
    def hash
      [pause_after_each_group, pause_on_error, parallel].hash
    end
