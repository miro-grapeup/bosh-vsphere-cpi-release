...
module NSXT
  ...
  class StandardHostSwitch
    ...
    def hash
      [pnics_uninstall_migration, ip_assignment_spec, cpu_config, is_migrate_pnics, vmk_uninstall_migration, pnics, host_switch_name, vmk_install_migration, host_switch_profile_ids].hash
    end
