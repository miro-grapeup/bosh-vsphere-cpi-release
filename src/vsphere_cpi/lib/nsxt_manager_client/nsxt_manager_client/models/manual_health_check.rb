...
module NSXT
  ...
  class ManualHealthCheck
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vlans')
        self.vlans = attributes[:'vlans']
      end

      if attributes.has_key?(:'operation_status')
    ...
    def valid?
      ...
      operation_status_validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'FINISHED'])
      return false unless operation_status_validator.valid?(@operation_status)
      true
    end
    ...
    def operation_status=(operation_status)
      validator = EnumAttributeValidator.new('String', ['IN_PROGRESS', 'FINISHED'])
      unless validator.valid?(operation_status)
        fail ArgumentError, 'invalid value for "operation_status", must be one of #{validator.allowable_values}.'
      end
      @operation_status = operation_status
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, transport_zone_id, vlans, operation_status, result].hash
    end
