...
module NSXT
  class TraceflowRequest
    ...
    def list_invalid_properties
      ...
      if @lport_id.nil?
        invalid_properties.push('invalid value for "lport_id", lport_id cannot be nil.')
      end
