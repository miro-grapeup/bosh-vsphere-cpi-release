...
module NSXT
  class LbCookiePersistenceProfile
    ...
    def valid?
      ...
      resource_type_validator = EnumAttributeValidator.new('String', ['LbCookiePersistenceProfile', 'LbSourceIpPersistenceProfile', 'LbGenericPersistenceProfile'])
    ...
    def resource_type=(resource_type)
      validator = EnumAttributeValidator.new('String', ['LbCookiePersistenceProfile', 'LbSourceIpPersistenceProfile', 'LbGenericPersistenceProfile'])
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, persistence_shared, cookie_garble, cookie_fallback, cookie_mode, cookie_domain, cookie_name, cookie_time, cookie_path].hash
    end
