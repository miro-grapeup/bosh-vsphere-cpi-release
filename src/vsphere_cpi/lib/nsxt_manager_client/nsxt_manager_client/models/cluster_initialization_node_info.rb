...
module NSXT
  ...
  class ClusterInitializationNodeInfo
    # The (internal) disk-store ID of the member
    attr_accessor :disk_store_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'disk_store_id')
        self.disk_store_id = attributes[:'disk_store_id']
      end

      if attributes.has_key?(:'host_address')
        self.host_address = attributes[:'host_address']
      end
    end
    ...
    def hash
      [disk_store_id, host_address].hash
    end
