...
module NSXT
  ...
  class DnsFailedQueries
    ...
    attr_accessor :per_node_failed_queries
    ...
    def self.swagger_types
      {
        :'timestamp' => :'String',
        :'per_node_failed_queries' => :'Array<PerNodeDnsFailedQueries>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'per_node_failed_queries')
        if (value = attributes[:'per_node_failed_queries']).is_a?(Array)
          self.per_node_failed_queries = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          per_node_failed_queries == o.per_node_failed_queries
    end
    ...
    def hash
      [timestamp, per_node_failed_queries].hash
    end
