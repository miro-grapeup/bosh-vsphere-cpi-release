...
module NSXT
  class AppInfoHostVmCsvRecord
    # vm ids that this application belongs to
    attr_accessor :host_vms
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'host_vms')
        self.host_vms = attributes[:'host_vms']
      end
    ...
    def hash
      [host_vms, version, display_name, os_type, id, manufacturer].hash
    end
