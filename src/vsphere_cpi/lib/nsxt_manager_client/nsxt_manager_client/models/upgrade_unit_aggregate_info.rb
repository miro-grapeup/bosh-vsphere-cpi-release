...
module NSXT
  class UpgradeUnitAggregateInfo
    ...
    attr_accessor :pre_upgrade_checks
    ...
    attr_accessor :post_upgrade_checks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pre_upgrade_checks')
        self.pre_upgrade_checks = attributes[:'pre_upgrade_checks']
      end
      ...
      if attributes.has_key?(:'post_upgrade_checks')
        self.post_upgrade_checks = attributes[:'post_upgrade_checks']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _schema == o._schema &&
          status == o.status &&
          pre_upgrade_checks == o.pre_upgrade_checks &&
          errors == o.errors &&
          display_name == o.display_name &&
          post_upgrade_checks == o.post_upgrade_checks &&
          warnings == o.warnings &&
    ...
    def hash
      [_self, _links, _schema, status, pre_upgrade_checks, errors, display_name, post_upgrade_checks, warnings, current_version, group, percent_complete, type, id, metadata].hash
    end
