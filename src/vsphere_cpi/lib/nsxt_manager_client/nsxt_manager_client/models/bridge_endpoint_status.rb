...
module NSXT
  class BridgeEndpointStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'active_nodes')
        if (value = attributes[:'active_nodes']).is_a?(Array)
    ...
    def hash
      [active_nodes, last_update_timestamp, endpoint_id].hash
    end
