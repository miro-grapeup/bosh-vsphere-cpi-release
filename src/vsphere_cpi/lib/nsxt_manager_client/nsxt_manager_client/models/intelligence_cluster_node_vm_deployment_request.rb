...
module NSXT
  ...
  class IntelligenceClusterNodeVMDeploymentRequest
    ...
    def valid?
      ...
      form_factor_validator = EnumAttributeValidator.new('String', ['SMALL', 'LARGE'])
    ...
    def form_factor=(form_factor)
      validator = EnumAttributeValidator.new('String', ['SMALL', 'LARGE'])
    ...
    def hash
      [deployment_config, vm_id, user_settings, form_factor].hash
    end
