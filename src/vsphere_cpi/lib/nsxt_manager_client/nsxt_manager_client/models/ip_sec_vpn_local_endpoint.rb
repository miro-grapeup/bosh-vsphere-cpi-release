...
module NSXT
  ...
  class IPSecVPNLocalEndpoint
    ...
    def self.swagger_types
      {
        ...
        :'trust_ca_ids' => :'Array<String>',
        :'local_id' => :'String',
        :'local_address' => :'String',
        :'certificate_id' => :'String',
        :'trust_crl_ids' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'trust_ca_ids')
        if (value = attributes[:'trust_ca_ids']).is_a?(Array)
          self.trust_ca_ids = value
        end
      end
      ...
      if attributes.has_key?(:'trust_crl_ids')
        if (value = attributes[:'trust_crl_ids']).is_a?(Array)
          self.trust_crl_ids = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @ipsec_vpn_service_id.nil?
        invalid_properties.push('invalid value for "ipsec_vpn_service_id", ipsec_vpn_service_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipsec_vpn_service_id.nil?
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, ipsec_vpn_service_id, trust_ca_ids, local_id, local_address, certificate_id, trust_crl_ids].hash
    end
