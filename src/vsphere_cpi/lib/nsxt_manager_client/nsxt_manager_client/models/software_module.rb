...
module NSXT
  ...
  class SoftwareModule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'module_version')
    ...
    def list_invalid_properties
      ...
      if @module_version.nil?
        invalid_properties.push('invalid value for "module_version", module_version cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @module_version.nil?
      true
    end
    ...
    def hash
      [module_name, module_version].hash
    end
