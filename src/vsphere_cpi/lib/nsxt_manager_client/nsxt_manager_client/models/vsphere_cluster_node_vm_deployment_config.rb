...
module NSXT
  ...
  class VsphereClusterNodeVMDeploymentConfig
    ...
    def hash
      [placement_type, dns_servers, search_domains, management_network_id, enable_ssh, allow_ssh_root_login, compute_id, ntp_servers, vc_id, storage_id, default_gateway_addresses, management_port_subnets, host_id, hostname].hash
    end
