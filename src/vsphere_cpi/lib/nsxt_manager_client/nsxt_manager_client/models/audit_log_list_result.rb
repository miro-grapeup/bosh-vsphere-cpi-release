...
module NSXT
  ...
  class AuditLogListResult
    ...
    attr_accessor :last_full_sync_timestamp
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'last_full_sync_timestamp')
        self.last_full_sync_timestamp = attributes[:'last_full_sync_timestamp']
      end
    ...
    def list_invalid_properties
      ...
      if @last_full_sync_timestamp.nil?
        invalid_properties.push('invalid value for "last_full_sync_timestamp", last_full_sync_timestamp cannot be nil.')
      end
    ...
    def valid?
      return false if @last_full_sync_timestamp.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_full_sync_timestamp == o.last_full_sync_timestamp &&
          results == o.results
    end
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, last_full_sync_timestamp, results].hash
    end
