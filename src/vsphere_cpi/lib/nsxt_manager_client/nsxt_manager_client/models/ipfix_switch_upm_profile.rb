...
module NSXT
  ...
  class IpfixSwitchUpmProfile
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, priority, collector_profile, idle_timeout, max_flows, observation_domain_id, active_timeout, export_overlay_flow, applied_tos, packet_sample_probability].hash
    end
