...
module NSXT
  class FirewallSectionState
    ...
    def list_invalid_properties
      ...
      if @pending_change_list.nil?
        invalid_properties.push('invalid value for "pending_change_list", pending_change_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pending_change_list.nil?
      true
    end
