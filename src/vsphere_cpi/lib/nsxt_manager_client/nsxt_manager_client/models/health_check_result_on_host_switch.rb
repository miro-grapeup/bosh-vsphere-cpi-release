...
module NSXT
  ...
  class HealthCheckResultOnHostSwitch
    ...
    attr_accessor :results_per_uplink
    ...
    def self.swagger_types
      {
        ...
        :'results_per_uplink' => :'Array<HealthCheckResultPerUplink>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'results_per_uplink')
        if (value = attributes[:'results_per_uplink']).is_a?(Array)
          self.results_per_uplink = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          results_per_uplink == o.results_per_uplink
    end
    ...
    def hash
      [host_switch_name, results_per_uplink].hash
    end
