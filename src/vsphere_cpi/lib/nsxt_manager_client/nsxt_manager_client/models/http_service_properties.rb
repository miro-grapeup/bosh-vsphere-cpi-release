  ...
  class HttpServiceProperties
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'global_api_concurrency_limit')
        ...
        self.global_api_concurrency_limit = 100
      end
    ...
    def hash
      [global_api_concurrency_limit, client_api_concurrency_limit, session_timeout, client_api_rate_limit, certificate, redirect_host, protocol_versions, cipher_suites, connection_timeout].hash
    end
