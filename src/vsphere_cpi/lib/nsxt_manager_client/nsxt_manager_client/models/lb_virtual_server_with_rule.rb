...
module NSXT
  class LbVirtualServerWithRule
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'virtual_server')
        self.virtual_server = attributes[:'virtual_server']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @virtual_server.nil?
        invalid_properties.push('invalid value for "virtual_server", virtual_server cannot be nil.')
      end
    ...
    def valid?
      return false if @virtual_server.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rules == o.rules &&
          virtual_server == o.virtual_server
    end
