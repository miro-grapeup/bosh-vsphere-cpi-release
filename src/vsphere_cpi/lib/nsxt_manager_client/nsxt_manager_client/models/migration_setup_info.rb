...
module NSXT
  ...
  class MigrationSetupInfo
    ...
    def self.swagger_types
      {
        ...
        :'source_nsx' => :'Array<SourceNsxApiEndpoint>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'destination_nsx')
        self.destination_nsx = attributes[:'destination_nsx']
      end

      if attributes.has_key?(:'source_nsx')
        if (value = attributes[:'source_nsx']).is_a?(Array)
          self.source_nsx = value
        end
      end

      if attributes.has_key?(:'migration_mode')
        self.migration_mode = attributes[:'migration_mode']
      else
        self.migration_mode = 'ONPREMISE_V2T'
      end
    end
    ...
    def valid?
      migration_mode_validator = EnumAttributeValidator.new('String', ['VMC_V2T', 'ONPREMISE_V2T', 'ONPREMISE_VSPHERE2T'])
    ...
    def migration_mode=(migration_mode)
      validator = EnumAttributeValidator.new('String', ['VMC_V2T', 'ONPREMISE_V2T', 'ONPREMISE_VSPHERE2T'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          destination_nsx == o.destination_nsx &&
          source_nsx == o.source_nsx &&
    ...
    def hash
      [destination_nsx, source_nsx, migration_mode].hash
    end
