...
module NSXT
  class ServiceEndpoint
    ...
    attr_accessor :service_endpoint_uuid
    ...
    def self.swagger_types
      {
        ...
        :'certificate' => :'String',
        :'entities_hosted' => :'Array<HostedEntityInfo>',
        :'ip_address' => :'String',
        :'fqdn' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entities_hosted')
        if (value = attributes[:'entities_hosted']).is_a?(Array)
          self.entities_hosted = value
        end
      end
      ...
      if attributes.has_key?(:'service_endpoint_uuid')
        self.service_endpoint_uuid = attributes[:'service_endpoint_uuid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          entities_hosted == o.entities_hosted &&
          ip_address == o.ip_address &&
          fqdn == o.fqdn &&
          service_endpoint_uuid == o.service_endpoint_uuid &&
          port == o.port
    end
    ...
    def hash
      [certificate_sha256_thumbprint, certificate, entities_hosted, ip_address, fqdn, service_endpoint_uuid, port].hash
    end
