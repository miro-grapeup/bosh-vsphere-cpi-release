...
module NSXT
  ...
  class TransportNode
    ...
    attr_accessor :failure_domain_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'failure_domain_id')
        self.failure_domain_id = attributes[:'failure_domain_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          failure_domain_id == o.failure_domain_id &&
