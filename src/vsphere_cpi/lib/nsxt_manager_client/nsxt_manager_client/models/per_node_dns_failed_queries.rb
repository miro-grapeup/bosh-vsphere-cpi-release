...
module NSXT
  ...
  class PerNodeDnsFailedQueries
    ...
    def hash
      [_self, _links, _schema, cursor, sort_ascending, sort_by, result_count, timestamp, node_id, results].hash
    end
