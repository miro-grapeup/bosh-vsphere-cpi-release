...
module NSXT
  ...
  class BgpConfig
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, inter_sr_ibgp, as_number, route_aggregation, logical_router_id, graceful_restart, as_num, enabled, graceful_restart_config, multipath_relax, ecmp].hash
    end
