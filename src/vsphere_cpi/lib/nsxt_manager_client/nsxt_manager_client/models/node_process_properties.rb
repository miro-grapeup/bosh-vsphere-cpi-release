...
module NSXT
  ...
  class NodeProcessProperties
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cpu_time')
        self.cpu_time = attributes[:'cpu_time']
      end

      if attributes.has_key?(:'ppid')
      ...
      if attributes.has_key?(:'mem_resident')
        self.mem_resident = attributes[:'mem_resident']
      end
    end
    ...
    def hash
      [_self, _links, _schema, mem_used, cpu_time, ppid, start_time, process_name, pid, uptime, mem_resident].hash
    end
