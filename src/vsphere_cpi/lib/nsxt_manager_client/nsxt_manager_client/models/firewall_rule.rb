...
module NSXT
  class FirewallRule
    ...
    def hash
      [_self, _links, _schema, _revision, _owner, display_name, id, resource_type, description, is_default, direction, rule_tag, ip_protocol, notes, applied_tos, logged, disabled, sources, action, priority, sources_excluded, destinations_excluded, destinations, services, context_profiles, extended_sources, section_id].hash
    end
