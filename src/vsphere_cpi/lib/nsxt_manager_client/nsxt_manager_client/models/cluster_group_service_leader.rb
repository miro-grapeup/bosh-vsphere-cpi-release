...
module NSXT
  ...
  class ClusterGroupServiceLeader
    # Name of the service
    attr_accessor :service_name

    # Number of times the lease has been renewed
    attr_accessor :lease_version

    # Member UUID of the leader
    attr_accessor :leader_uuid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lease_version')
        self.lease_version = attributes[:'lease_version']
      end

      if attributes.has_key?(:'leader_uuid')
        self.leader_uuid = attributes[:'leader_uuid']
      end
    end
    ...
    def hash
      [service_name, lease_version, leader_uuid].hash
    end
