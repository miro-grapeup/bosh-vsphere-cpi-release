...
module NSXT
  class AllocatedService
    ...
    def self.swagger_types
      {
        ...
        :'allocation_details' => :'Array<KeyValuePair>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_reference')
        self.service_reference = attributes[:'service_reference']
      end
      ...
      if attributes.has_key?(:'allocation_details')
        if (value = attributes[:'allocation_details']).is_a?(Array)
          self.allocation_details = value
        end
      end
    end
    ...
    def valid?
      high_availability_status_validator = EnumAttributeValidator.new('String', ['ACTIVE', 'STANDBY', 'DOWN', 'SYNC', 'UNKNOWN'])
    ...
    def high_availability_status=(high_availability_status)
      validator = EnumAttributeValidator.new('String', ['ACTIVE', 'STANDBY', 'DOWN', 'SYNC', 'UNKNOWN'])
    ...
    def hash
      [service_reference, high_availability_status, allocation_details].hash
    end
