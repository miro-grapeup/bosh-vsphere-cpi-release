...
module NSXT
  class IPv6Profiles
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dad_profile_id')
        self.dad_profile_id = attributes[:'dad_profile_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          dad_profile_id == o.dad_profile_id &&
    ...
    def hash
      [dad_profile_id, ndra_profile_id].hash
    end
