...
module NSXT
  ...
  class IntelligenceVsphereClusterNodeVMDeploymentConfig
    ...
    def valid?
      ...
      placement_type_validator = EnumAttributeValidator.new('String', ['IntelligenceVsphereClusterNodeVMDeploymentConfig'])
    ...
    def placement_type=(placement_type)
      validator = EnumAttributeValidator.new('String', ['IntelligenceVsphereClusterNodeVMDeploymentConfig'])
    ...
    def hash
      [placement_type, ovf_url, dns_servers, display_name, ntp_servers, hostname, enable_ssh, allow_ssh_root_login, compute_id, vc_id, storage_id, default_gateway_addresses, management_port_subnets, host_id, management_network_id].hash
    end
