...
module NSXT
  ...
  class ContainerCluster
    ...
    def valid?
      ...
      cluster_type_validator = EnumAttributeValidator.new('String', ['PAS', 'PKS', 'Kubernetes', 'Openshift', 'WCP', 'Other'])
    ...
    def cluster_type=(cluster_type)
      validator = EnumAttributeValidator.new('String', ['PAS', 'PKS', 'Kubernetes', 'Openshift', 'WCP', 'Other'])
    ...
    def hash
      [_self, _links, _schema, _last_sync_time, display_name, description, resource_type, tags, cluster_type, origin_properties, external_id, infrastructure].hash
    end
