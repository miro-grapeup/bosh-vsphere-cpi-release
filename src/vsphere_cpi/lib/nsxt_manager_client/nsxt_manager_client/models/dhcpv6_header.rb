...
module NSXT
  class Dhcpv6Header
    ...
    def valid?
      msg_type_validator = EnumAttributeValidator.new('String', ['SOLICIT', 'ADVERTISE', 'REQUEST', 'REPLY'])
    ...
    def msg_type=(msg_type)
      validator = EnumAttributeValidator.new('String', ['SOLICIT', 'ADVERTISE', 'REQUEST', 'REPLY'])
