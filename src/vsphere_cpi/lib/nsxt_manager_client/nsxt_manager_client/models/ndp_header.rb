...
module NSXT
  ...
  class NdpHeader
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'msg_type')
        self.msg_type = attributes[:'msg_type']
      else
        self.msg_type = 'NEIGHBOR_SOLICITATION'
      end
    end
    ...
    def valid?
      msg_type_validator = EnumAttributeValidator.new('String', ['NEIGHBOR_SOLICITATION', 'NEIGHBOR_ADVERTISEMENT'])
      return false unless msg_type_validator.valid?(@msg_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] msg_type Object to be assigned
    def msg_type=(msg_type)
      validator = EnumAttributeValidator.new('String', ['NEIGHBOR_SOLICITATION', 'NEIGHBOR_ADVERTISEMENT'])
