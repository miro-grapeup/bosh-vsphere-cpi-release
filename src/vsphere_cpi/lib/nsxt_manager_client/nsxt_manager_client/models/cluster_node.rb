...
module NSXT
  ...
  class ClusterNode
    ...
    def self.swagger_types
      {
        :'status' => :'String',
        :'entities' => :'Array<ClusterNodeEntity>',
        :'node_uuid' => :'String'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @node_uuid.nil?
        invalid_properties.push('invalid value for "node_uuid", node_uuid cannot be nil.')
      end
    ...
    def hash
      [status, entities, node_uuid].hash
    end
