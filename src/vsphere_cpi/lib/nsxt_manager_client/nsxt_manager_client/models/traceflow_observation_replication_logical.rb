...
module NSXT
  class TraceflowObservationReplicationLogical
    ...
    def valid?
      ...
      replication_type_validator = EnumAttributeValidator.new('String', ['TX_VTEP', 'TX_MTEP', 'RX'])
    ...
    def replication_type=(replication_type)
      validator = EnumAttributeValidator.new('String', ['TX_VTEP', 'TX_MTEP', 'RX'])
    ...
    def hash
      [timestamp_micro, component_sub_type, resource_type, component_type, transport_node_name, timestamp, transport_node_id, sequence_no, transport_node_type, component_name, vtep_label, replication_type, local_ip_address, uplink_name].hash
    end
