...
module NSXT
  ...
  class NodeLogProperties
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'log_size')
        self.log_size = attributes[:'log_size']
      end

      if attributes.has_key?(:'log_name')
        self.log_name = attributes[:'log_name']
      end
    end
    ...
    def hash
      [_self, _links, _schema, last_modified_time, log_size, log_name].hash
    end
