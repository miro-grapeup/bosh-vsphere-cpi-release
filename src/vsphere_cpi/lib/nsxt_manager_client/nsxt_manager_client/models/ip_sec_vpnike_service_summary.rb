...
module NSXT
  ...
  class IPSecVPNIKEServiceSummary
    ...
    def hash
      [traffic_summary_per_session, last_update_timestamp, session_summary, aggregate_traffic_counters, ipsec_vpn_service_id, display_name, logical_router_id].hash
    end
