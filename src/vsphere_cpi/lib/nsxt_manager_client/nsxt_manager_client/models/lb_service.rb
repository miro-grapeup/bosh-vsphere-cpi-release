...
module NSXT
  class LbService
    ...
    attr_accessor :virtual_server_ids
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'virtual_server_ids' => :'Array<String>',
        :'size' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'virtual_server_ids')
        if (value = attributes[:'virtual_server_ids']).is_a?(Array)
          self.virtual_server_ids = value
        end
      end
    ...
    def valid?
      ...
      size_validator = EnumAttributeValidator.new('String', ['SMALL', 'MEDIUM', 'LARGE', 'DLB'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enabled == o.enabled &&
          virtual_server_ids == o.virtual_server_ids &&
          size == o.size
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, access_log_enabled, attachment, error_log_level, enabled, virtual_server_ids, size].hash
    end
