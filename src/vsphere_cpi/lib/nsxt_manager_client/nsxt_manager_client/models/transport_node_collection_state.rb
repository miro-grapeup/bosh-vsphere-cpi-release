...
module NSXT
  ...
  class TransportNodeCollectionState
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ['FAILED_TO_CREATE', 'FAILED_TO_REALIZE', 'IN_PROGRESS', 'PROFILE_MISMATCH', 'SUCCESS'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ['FAILED_TO_CREATE', 'FAILED_TO_REALIZE', 'IN_PROGRESS', 'PROFILE_MISMATCH', 'SUCCESS'])
    ...
    def hash
      [state, aggregate_progress_percentage].hash
    end
