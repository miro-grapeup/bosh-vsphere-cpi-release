...
module NSXT
  ...
  class MPAConfigProperties
    ...
    def self.swagger_types
      {
        ...
        :'rmq_broker_cluster' => :'Array<BrokerProperties>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RmqClientType')
        self.rmq_client_type = attributes[:'RmqClientType']
      end

      if attributes.has_key?(:'RmqBrokerCluster')
        if (value = attributes[:'RmqBrokerCluster']).is_a?(Array)
          self.rmq_broker_cluster = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _links == o._links &&
          _schema == o._schema &&
          rmq_client_type == o.rmq_client_type &&
          rmq_broker_cluster == o.rmq_broker_cluster &&
    ...
    def hash
      [_self, _links, _schema, rmq_client_type, rmq_broker_cluster, shared_secret, account_name].hash
    end
