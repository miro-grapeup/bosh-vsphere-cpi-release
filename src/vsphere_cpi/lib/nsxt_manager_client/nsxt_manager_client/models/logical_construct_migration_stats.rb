...
module NSXT
  ...
  class LogicalConstructMigrationStats
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'source_count')
      ...
      if attributes.has_key?(:'target_count')
    ...
    def hash
      [source_type, source_count, target_type, vertical, target_count].hash
    end
