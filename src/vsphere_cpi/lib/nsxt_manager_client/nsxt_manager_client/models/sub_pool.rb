...
module NSXT
  class SubPool
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sub_pool_type')
        self.sub_pool_type = attributes[:'sub_pool_type']
      end
    end
    ...
    def hash
      [usage_percentage, remaining_credit_number, sub_pool_type].hash
    end
