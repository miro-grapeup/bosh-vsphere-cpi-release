...
module NSXT
  ...
  class PortConnectionEntities
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'physical_hosts')
        self.physical_hosts = attributes[:'physical_hosts']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vms == o.vms &&
          tunnels == o.tunnels &&
          physical_hosts == o.physical_hosts
    end
    ...
    def hash
      [containers, hypervisors, errors, logical_switches, edge_node_groups, routers, vms, tunnels, physical_hosts].hash
    end
