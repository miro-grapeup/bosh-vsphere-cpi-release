...
module NSXT
  class IcmpEchoRequestHeader
    ...
    def list_invalid_properties
      ...
      if !@id.nil? && @id > 65535
        invalid_properties.push('invalid value for "id", must be smaller than or equal to 65535.')
      end
      ...
      if !@sequence.nil? && @sequence > 65535
        invalid_properties.push('invalid value for "sequence", must be smaller than or equal to 65535.')
      end
    ...
    def valid?
      return false if !@id.nil? && @id > 65535
      return false if !@id.nil? && @id < 0
      return false if !@sequence.nil? && @sequence > 65535
    ...
    def id=(id)
      if !id.nil? && id > 65535
        fail ArgumentError, 'invalid value for "id", must be smaller than or equal to 65535.'
      end
    ...
    def sequence=(sequence)
      if !sequence.nil? && sequence > 65535
        fail ArgumentError, 'invalid value for "sequence", must be smaller than or equal to 65535.'
      end
