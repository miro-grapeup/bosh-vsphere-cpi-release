...
module NSXT
  ...
  class NodeTime
    ...
    def list_invalid_properties
      ...
      if @system_datetime.nil?
        invalid_properties.push('invalid value for "system_datetime", system_datetime cannot be nil.')
      end
    ...
    def valid?
      return false if @system_datetime.nil?
      true
    end
