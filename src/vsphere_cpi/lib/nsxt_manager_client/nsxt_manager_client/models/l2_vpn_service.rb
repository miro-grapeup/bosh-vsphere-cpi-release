...
module NSXT
  ...
  class L2VpnService
    ...
    attr_accessor :enable_full_mesh
    ...
    attr_accessor :logical_tap_ip_pool
    ...
    def self.swagger_types
      {
        ...
        :'enable_full_mesh' => :'BOOLEAN',
        :'enable_hub' => :'BOOLEAN',
        :'logical_router_id' => :'String',
        :'mode' => :'String',
        :'logical_tap_ip_pool' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enable_full_mesh')
        self.enable_full_mesh = attributes[:'enable_full_mesh']
      else
        self.enable_full_mesh = false
      end
      ...
      if attributes.has_key?(:'logical_tap_ip_pool')
        if (value = attributes[:'logical_tap_ip_pool']).is_a?(Array)
          self.logical_tap_ip_pool = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_full_mesh == o.enable_full_mesh &&
          enable_hub == o.enable_hub &&
          logical_router_id == o.logical_router_id &&
          mode == o.mode &&
          logical_tap_ip_pool == o.logical_tap_ip_pool
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, enable_full_mesh, enable_hub, logical_router_id, mode, logical_tap_ip_pool].hash
    end
