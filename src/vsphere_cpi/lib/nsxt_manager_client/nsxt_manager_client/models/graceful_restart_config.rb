...
module NSXT
  ...
  class GracefulRestartConfig
    ...
    attr_accessor :graceful_restart_timer
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'graceful_restart_mode')
        ...
        self.graceful_restart_mode = 'HELPER_ONLY'
      end

      if attributes.has_key?(:'graceful_restart_timer')
        self.graceful_restart_timer = attributes[:'graceful_restart_timer']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          graceful_restart_timer == o.graceful_restart_timer
    end
    ...
    def hash
      [graceful_restart_mode, graceful_restart_timer].hash
    end
