...
module NSXT
  ...
  class ServiceDeploymentIssue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'issue_description')
        self.issue_description = attributes[:'issue_description']
      end

      if attributes.has_key?(:'issue_timestamp')
        self.issue_timestamp = attributes[:'issue_timestamp']
      end

      if attributes.has_key?(:'issue_type')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          issue_timestamp == o.issue_timestamp &&
    ...
    def hash
      [issue_description, issue_timestamp, issue_type].hash
    end
