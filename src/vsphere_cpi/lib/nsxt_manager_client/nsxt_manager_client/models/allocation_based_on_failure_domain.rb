...
module NSXT
  ...
  class AllocationBasedOnFailureDomain
    ...
    def valid?
      ...
      action_type_validator = EnumAttributeValidator.new('String', ['AllocationBasedOnFailureDomain'])
    ...
    def action_type=(action_type)
      validator = EnumAttributeValidator.new('String', ['AllocationBasedOnFailureDomain'])
