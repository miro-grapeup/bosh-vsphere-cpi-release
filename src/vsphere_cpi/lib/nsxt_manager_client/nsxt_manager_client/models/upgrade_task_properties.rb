...
module NSXT
  ...
  class UpgradeTaskProperties
    ...
    def list_invalid_properties
      ...
      if @bundle_name.nil?
        invalid_properties.push('invalid value for "bundle_name", bundle_name cannot be nil.')
      end
    ...
    def valid?
      return false if @bundle_name.nil?
      true
    end
    ...
    def hash
      [bundle_name, step, parameters].hash
    end
