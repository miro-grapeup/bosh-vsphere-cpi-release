...
module NSXT
  class RouteMapSequenceSet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'large_community')
        self.large_community = attributes[:'large_community']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          weight == o.weight &&
          large_community == o.large_community &&
    ...
    def hash
      [local_preference, weight, large_community, as_path_prepend, community, multi_exit_discriminator].hash
    end
