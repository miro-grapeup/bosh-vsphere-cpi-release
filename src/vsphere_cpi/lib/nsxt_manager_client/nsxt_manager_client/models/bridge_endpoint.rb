...
module NSXT
  ...
  class BridgeEndpoint
    ...
    # This property is used for VLAN trunk specification of edge bridge endpoint. It's mutually exclusive with 'vlan', either 'vlan' or 'vlan_trunk_spec' should be specified. 
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, ha_enable, bridge_cluster_id, vlan_transport_zone_id, bridge_endpoint_profile_id, uplink_teaming_policy_name, vlan_trunk_spec, vlan].hash
    end
