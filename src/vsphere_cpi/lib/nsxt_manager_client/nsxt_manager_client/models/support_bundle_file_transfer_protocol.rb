...
module NSXT
  class SupportBundleFileTransferProtocol
    ...
    def valid?
      ...
      name_validator = EnumAttributeValidator.new('String', ['SCP', 'SFTP'])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ['SCP', 'SFTP'])
    ...
    def hash
      [ssh_fingerprint, name, authentication_scheme].hash
    end
