...
module NSXT
  ...
  class NodeStatusProperties
    ...
    def hash
      [_self, _links, _schema, load_average, swap_used, cpu_usage, non_dpdk_cpu_cores, swap_total, system_time, cpu_cores, uptime, mem_cache, mem_total, mem_used, dpdk_cpu_cores, file_systems, source].hash
    end
