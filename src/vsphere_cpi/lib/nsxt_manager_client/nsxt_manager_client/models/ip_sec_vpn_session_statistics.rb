...
module NSXT
  ...
  class IPSecVPNSessionStatistics
    ...
    def hash
      [ike_traffic_statistics, display_name, policy_statistics, partial_stats, ipsec_vpn_session_id, last_update_timestamp, ike_status, aggregate_traffic_counters].hash
    end
