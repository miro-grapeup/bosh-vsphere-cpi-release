...
module NSXT
  ...
  class ApiServiceConfig
    ...
    def hash
      [global_api_concurrency_limit, lockout_immune_addresses, client_api_concurrency_limit, session_timeout, client_api_rate_limit, redirect_host, protocol_versions, cipher_suites, connection_timeout].hash
    end
