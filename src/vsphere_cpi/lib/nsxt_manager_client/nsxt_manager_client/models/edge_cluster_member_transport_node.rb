...
module NSXT
  class EdgeClusterMemberTransportNode
    ...
    def list_invalid_properties
      ...
      if @member_index.nil?
        invalid_properties.push('invalid value for "member_index", member_index cannot be nil.')
      end
    ...
    def valid?
      return false if @member_index.nil?
    ...
    def hash
      [member_index, transport_node_id].hash
    end
