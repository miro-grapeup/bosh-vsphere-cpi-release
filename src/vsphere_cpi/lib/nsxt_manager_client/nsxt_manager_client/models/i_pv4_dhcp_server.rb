...
module NSXT
  ...
  class IPv4DhcpServer
    ...
    attr_accessor :monitor_ippool_usage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'monitor_ippool_usage')
        self.monitor_ippool_usage = attributes[:'monitor_ippool_usage']
      else
        self.monitor_ippool_usage = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          options == o.options &&
          monitor_ippool_usage == o.monitor_ippool_usage &&
    ...
    def hash
      [options, monitor_ippool_usage, dhcp_server_ip, dns_nameservers, domain_name, gateway_ip].hash
    end
