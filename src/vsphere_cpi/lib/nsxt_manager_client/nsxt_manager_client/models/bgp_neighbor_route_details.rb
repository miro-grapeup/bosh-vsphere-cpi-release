...
module NSXT
  ...
  class BgpNeighborRouteDetails
    ...
    attr_accessor :per_transport_node_routes
    ...
    def self.swagger_types
      {
        ...
        :'neighbor_id' => :'String',
        :'per_transport_node_routes' => :'Array<RoutesPerTransportNode>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'per_transport_node_routes')
        if (value = attributes[:'per_transport_node_routes']).is_a?(Array)
          self.per_transport_node_routes = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          per_transport_node_routes == o.per_transport_node_routes &&
    ...
    def hash
      [logical_router_id, neighbor_id, per_transport_node_routes, neighbor_address].hash
    end
