...
module NSXT
  class ComponentUpgradeStatus
    ...
    def self.swagger_types
      {
        ...
        :'node_count_at_target_version' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pre_upgrade_status')
      ...
      if attributes.has_key?(:'node_count_at_target_version')
        self.node_count_at_target_version = attributes[:'node_count_at_target_version']
      end

      if attributes.has_key?(:'target_component_version')
      ...
      if attributes.has_key?(:'can_skip')
