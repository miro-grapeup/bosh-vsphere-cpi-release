...
module NSXT
  class RepoSyncStatusReport
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['NOT_STARTED', 'IN_PROGRESS', 'FAILED', 'SUCCESS'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['NOT_STARTED', 'IN_PROGRESS', 'FAILED', 'SUCCESS'])
    ...
    def hash
      [status, status_message, failure_message, failure_code].hash
    end
