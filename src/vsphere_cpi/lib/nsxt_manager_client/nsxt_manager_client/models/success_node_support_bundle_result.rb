...
module NSXT
  class SuccessNodeSupportBundleResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bundle_size')
        self.bundle_size = attributes[:'bundle_size']
      end
    end
    ...
    def hash
      [bundle_name, node_display_name, node_id, sha256_thumbprint, bundle_size].hash
    end
