...
module NSXT
  class TunnelProperties
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latency_type')
        self.latency_type = attributes[:'latency_type']
      end

      if attributes.has_key?(:'latency_value')
    ...
    def valid?
      ...
      latency_type_validator = EnumAttributeValidator.new('String', ['UNKNOWN_LATENCY', 'VALID', 'NOT_READY', 'TIMEOUT'])
    ...
    def latency_type=(latency_type)
      validator = EnumAttributeValidator.new('String', ['UNKNOWN_LATENCY', 'VALID', 'NOT_READY', 'TIMEOUT'])
