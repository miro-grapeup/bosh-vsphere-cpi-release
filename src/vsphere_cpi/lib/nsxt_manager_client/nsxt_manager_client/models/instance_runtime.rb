...
module NSXT
  ...
  class InstanceRuntime
    ...
    attr_accessor :runtime_health_status_by_partner
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'runtime_health_status_by_partner')
        self.runtime_health_status_by_partner = attributes[:'runtime_health_status_by_partner']
      end

      if attributes.has_key?(:'unhealthy_reason')
        self.unhealthy_reason = attributes[:'unhealthy_reason']
      end
    end
    ...
    def valid?
      ...
      runtime_health_status_by_partner_validator = EnumAttributeValidator.new('String', ['HEALTHY', 'STOPPED', 'NOT_RESPONDING'])
      return false unless runtime_health_status_by_partner_validator.valid?(@runtime_health_status_by_partner)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] runtime_health_status_by_partner Object to be assigned
    def runtime_health_status_by_partner=(runtime_health_status_by_partner)
      validator = EnumAttributeValidator.new('String', ['HEALTHY', 'STOPPED', 'NOT_RESPONDING'])
      unless validator.valid?(runtime_health_status_by_partner)
        fail ArgumentError, 'invalid value for "runtime_health_status_by_partner", must be one of #{validator.allowable_values}.'
      end
      @runtime_health_status_by_partner = runtime_health_status_by_partner
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          runtime_health_status_by_partner == o.runtime_health_status_by_partner &&
          unhealthy_reason == o.unhealthy_reason
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, service_vm_id, deployment_status, vm_nic_info, maintenance_mode, runtime_status, error_message, service_instance_id, runtime_health_status_by_partner, unhealthy_reason].hash
    end
