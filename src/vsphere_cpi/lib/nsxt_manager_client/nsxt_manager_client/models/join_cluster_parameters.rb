...
module NSXT
  ...
  class JoinClusterParameters
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'certficate_sha256_thumbprint')
        self.certficate_sha256_thumbprint = attributes[:'certficate_sha256_thumbprint']
      end
    ...
    def list_invalid_properties
      ...
      if @certficate_sha256_thumbprint.nil?
        invalid_properties.push('invalid value for "certficate_sha256_thumbprint", certficate_sha256_thumbprint cannot be nil.')
      end
    ...
    def valid?
      return false if @certficate_sha256_thumbprint.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          username == o.username &&
          certficate_sha256_thumbprint == o.certficate_sha256_thumbprint &&
          token == o.token &&
    ...
    def hash
      [username, certficate_sha256_thumbprint, token, cluster_id, password, ip_address, port].hash
    end
