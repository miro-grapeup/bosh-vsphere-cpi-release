...
module NSXT
  class CertificateKeyPair
    ...
    def list_invalid_properties
      ...
      if !@rsa_private_key.nil? && @rsa_private_key.to_s.length < 60
        invalid_properties.push('invalid value for "rsa_private_key", the character length must be great than or equal to 60.')
      end
    ...
    def valid?
      return false if !@rsa_private_key.nil? && @rsa_private_key.to_s.length < 60
    ...
    def rsa_private_key=(rsa_private_key)
      if !rsa_private_key.nil? && rsa_private_key.to_s.length < 60
        fail ArgumentError, 'invalid value for "rsa_private_key", the character length must be great than or equal to 60.'
      end
    ...
    def hash
      [rsa_private_key, certificate].hash
    end
