...
module NSXT
  ...
  class NodeSearchDomainsProperties
    ...
    def list_invalid_properties
      ...
      if @search_domains.nil?
        invalid_properties.push('invalid value for "search_domains", search_domains cannot be nil.')
      end
    ...
    def valid?
      return false if @search_domains.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, search_domains].hash
    end
