...
module NSXT
  ...
  class OrgInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'org_id')
        self.org_id = attributes[:'org_id']
      end

      if attributes.has_key?(:'org_role')
        self.org_role = attributes[:'org_role']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @org_role.nil?
        invalid_properties.push('invalid value for "org_role", org_role cannot be nil.')
      end
