...
module NSXT
  ...
  class PolicyBasedIPSecVPNSession
    ...
    def self.swagger_types
      {
        ...
        :'enabled' => :'BOOLEAN',
        :'policy_rules' => :'Array<IPSecVPNPolicyRule>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'policy_rules')
        if (value = attributes[:'policy_rules']).is_a?(Array)
          self.policy_rules = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @policy_rules.nil?
        invalid_properties.push('invalid value for "policy_rules", policy_rules cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @policy_rules.nil?
      true
    end
    ...
    def hash
      [_self, _links, _schema, _revision, _system_owned, display_name, description, tags, _create_user, _protection, _create_time, _last_modified_time, _last_modified_user, id, resource_type, peer_endpoint_id, ipsec_vpn_service_id, local_endpoint_id, tcp_mss_clamping, enabled, policy_rules].hash
    end
